...
@section('employeecontent')
    <div style="display:flex;">
        ...
        <div style="margin-top:20px; margin-left:900px;">
            ...
            <a href="/manage/hrm/employee-details/paysel-SXuz2t3Z"><button type="button"
                        ...
                        <div>
                            <div class="row my-5">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="checkbox" name="{{ $module->link_name }}[]" value="{{ $submodule->id }}"
                                        @if ($submodule->status == 1) checked @endif>
                    ...
                    <div>
                        ...
                        <div class="row my-5">
                            ...
                            <div class="col-sm-4">
                                    ...
                                    <input type="checkbox"
                                        @if ($module->link_name == 'Risk & Complaince') name="risk_complaince[]" @else name="{{ $module->link_name }}[]" @endif
                                        value="{{ $module->id }}" @if ($module->status == 1) checked @endif>
