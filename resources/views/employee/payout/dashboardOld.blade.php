...
<div class="row">
    ...
    <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="card">
            ...
            <div class="card-body" id="transactionGraph" style="height:450px; width:1000px;">
    ...
    <div class="col-sm-10 col-sm-offset-1" style="margin-top:20px; margin-bottom:30px;">
