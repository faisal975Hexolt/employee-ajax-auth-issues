        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul class="nav nav-tabs" id="transaction-tabs">
                    <li class="active"><a data-toggle="tab" class="show-cursor" data-target="#dashboard">Payout Dashboard</a></li>
                </ul>
            </div>
            <div class="panel-body">
                <div class="tab-content">
                    <div id="dashboard" class="tab-pane fade in active">
                      ...
                      <div class="row g-4 mb-4">
                        ...
                        <div class="col-6 col-lg-6">
                            <select name="" class="form-control" id="merchant_id">
                     ...
                     <div class="row g-4 mb-4">
                          ...
                          <div class="col-6 col-lg-6">
                            <div class="app-card app-card-stat shadow-sm h-100" style="background-image: linear-gradient(120deg, #0073b7 0%, #637e8e 100%);">
                                <div class="app-card-body p-3 p-lg-4">
                                    <h4 class="stats-type mb-1" style="color:white;font-weight:900;height:40px;">Total GTV </h4>
                                    <div class="stats-figure" id="totalAmount" style="color:white;font-weight:900;">₹0.00 </div>
                         ...
                         <div class="col-6 col-lg-6">
                            <div class="app-card app-card-stat shadow-sm h-100" style="background-image: linear-gradient(-20deg, #fc6076 0%, #ff9a44 100%);">
                                <div class="app-card-body p-3 p-lg-4">
                                    ...
                                    <div class="stats-figure" id="successfulTransaction" style="color:white;font-weight:900;">#0</div>
                                </div>
                                <a class="app-card-link-mask" href="#"></a>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                      <div class="card ">
                        <div class="card-header">
                            <h3 class="box-title" id="paymentModeTitle">Vendors</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="card-body">
                            <div id="graph-4"></div>
                            <div class="text-center text-muted" id="payment-mode-graph-empty"> No data for selected date
                                range
                            </div>
                        </div>
                    </div><!-- /.box -->
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title" id="deviceTitle">Payments Mode Distribution </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="card-body">
                            <div id="graph-6"></div>
                            <div class="text-center text-muted" id="device-graph-empty"> No data for selected date range
                            </div>
                        </div>
                    </div><!-- /.box -->
                </div>
    ...
    $(function() {
        ...
        $('input[name="datetimes"]').daterangepicker({
            ...
            $.ajax({
                ...
                url: "{{url('/')}}/manage/payout_dashboard_transactionstats",
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        function cb(start, end) {
            ...
            $('input[name="datetimes"] span').html(start.format('D MMMM, YYYY') + ' - ' + end.format('D MMMM, YYYY'));
            ...
            $.ajax({
                ...
                url: "{{url('/')}}/manage/payout_dashboard_graph",
                ...
                //graph 1 end
                    ...
                    console.log(vendorData, vendorLabels)
        ...
        legend: {
            ...
            labels: {
                filter: function(item, chart) {
                    // Show labels for non-zero values
                    return vendorData[item.index] > 0;
                }
            }
        },
        tooltips: {
