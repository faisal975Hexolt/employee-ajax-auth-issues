...
<div class="row">
    ...
    <div class="col-sm-3">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Add Price Settings</button>
    ...
    <div class="col-sm-3">
       ...
       <a href="/manage/price_setting"><button type="button" class="btn btn-primary">Back</button></a> 
    ...
    <div class="modal-dialog modal-lg .modal-dialog-scrollable">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Price Setting form</h4>
            ...
            <div class="modal-body">
                ...
                <form action="/manage/save_price_setting" method="POST" class="form-horizontal" role="form">
                    ...
                    <div class="form-group form-fit">
                        ...
                        <label for="input" class="col-sm-3 control-label" style="margin-left:0px;">Merchant:<span class="text-danger">*</span></label>
                    ...
                    <div class="form-group form-fit" id="ranges" style="display:none;">
                        ...
                        <label for="input" class="col-sm-2 control-label">Type:<span class="text-danger">*</span></label>
                        ...
                        <label for="input" class="col-sm-2 control-label">Min Range:<span class="text-danger">*</span></label>
                        ...
                        <label for="input" class="col-sm-2 control-label">Max Range:<span class="text-danger">*</span></label>
                    ...
                    <div id="details" style="display:none;">
                        ...
                        <div id="formRow">
                            ...
                            <div class="form-group form-fit">
                                ...
                                <label for="input" class="col-sm-2 control-label">IMPS:<span class="text-danger">*</span></label>
                                ...
                                <label for="input" class="col-sm-2 control-label">NEFT:<span class="text-danger">*</span></label>
                                ...
                                <label for="input" class="col-sm-2 control-label">RTGS:<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group form-fit">
                                ...
                                <label for="input" class="col-sm-2 control-label">UPI:<span class="text-danger">*</span></label>
...
<div class="card">
    ...
    <div class="text-left ">
        ...
        <div class="" style="display:flex;">
            ...
            <div class="" style=" flex-basis: 300px;">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><button class="btn " data-toggle="modal" data-id="{{$price->id}}" data-target="#deleteModal">
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" style="margin-top:150px" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="/manage/delete_price_setting" method="POST">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" style="margin-top:150px" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/manage/edit_price_setting" method="POST" class="form-horizontal" role="form">
...
<script>
    ...
    $('#addRow').on('click', function(event) {
        ...
        $('#formRow').append(`<div style="border-top:1px brown solid; padding:5px 5px 5px 5px ;">
