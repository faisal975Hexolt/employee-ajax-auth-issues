                                    ...
                                    <div class="modal-body">
                                        <form id="merchant-commercial" class="form-horizontal" role="form" autocomplete="off">
                                            <div class="form-group form-fit">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="merchant_id" id="merchant_id" class="form-control" required="required" disabled>
                                            ...
                                            <div class="form-group form-fit">
                                                ...
                                                <div class="col-sm-3">
                                                    <select name="business_category_id" id="business_category_id" class="form-control" required="required" >
                                                        ...
                                                        @foreach(App\BusinessCategory::get_category() as $index => $businessCat)
                                                            <option value="{{$businessCat->id}}">{{$businessCat->category_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <select name="business_sub_category_id" id="business_sub_category_id" class="form-control" required="required" >
                                                        <option value="">--Select--</option>
                                                        @foreach(getbusinessSubcategoryHelper(1) as $index => $businessCat)
                                                            <option value="{{$businessCat->id}}">{{$businessCat->sub_category_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
