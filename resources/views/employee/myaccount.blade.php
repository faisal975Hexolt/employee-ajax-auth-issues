                                ...
                                <form action="{{route('verify-emailOTP')}}" method="POST" class="form-horizontal" role="form">                                   
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="managepayemailOTP" id="managepayemailOTP" class="form-control" value="" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-3 col-sm-offset-2">
                                ...
                                <form action="{{route('verify-mobileOTP')}}" method="POST" class="form-horizontal" role="form">                                   
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="managepaymobileOTP" id="managepaymobileOTP" class="form-control" value="" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-3 col-sm-offset-2">
