                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body" style="">
                                @if (!empty($info['transaction_info']['created_date']))
                                    <div class="row" style="margin: 0 1%;">
                                        ...
                                        <div class="col-sm-6 text-left item"
                                            ...
                                            <b>{{ \Carbon\Carbon::parse($info['transaction_info']['created_date'])->format('M d, Y H:i:s') }}</b>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if (!empty($info['transaction_info']['payment_datetime']))
                                    <div class="row" style="margin: 0 1%;">
                                        ...
                                        <div class="col-sm-6 text-left item"
                                            style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            <b> {{ \Carbon\Carbon::parse($info['transaction_info']['payment_datetime'] )->format('M d, Y H:i:s') }}</b>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="row" style="margin: 0 1%;">
                                    ...
                                    <div class="col-sm-6 text-left item"
                                        style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                        <strong class="copy-to-clipboard-text"
                                            id="bank_ref_no">{{ $info['transaction_info']['bank_ref_no'] }}</strong>&nbsp;&nbsp;&nbsp;<span
                                           >
                                        </span>
                                    </div>
                                </div>
                            @endif
                                ...
                                @if (!empty($info['transaction_info']['id']))
                                    <div class="row" style="margin: 0 1%;">
                                        <div class="col-sm-6 text-right item"
                                            style="text-align: left; padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            Transaction Sequence ID:</div>
                                        <div class="col-sm-6 text-left item"
                                            style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            <strong class="copy-to-clipboard-text"
                                                id="transaction_sequence_id">{{ $info['transaction_info']['id'] }}</strong>&nbsp;&nbsp;&nbsp;<span
                                                title="Copy" onclick="copyToClipboard('transaction_sequence_id')"
                                                class="copy_to_clipboard ctc_transaction_sequence_id">
                                            </span>
                                        </div>
                                    </div>
                                @endif

                                @if (!empty($acquirer->bank_name))
                                    <div class="row" style="margin: 0 1%;">
                                        <div class="col-sm-6 text-right item"
                                            style="text-align: left; padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            Acquirer Name:</div>
                                        <div class="col-sm-6 text-left item"
                                            style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            <b>{{ $acquirer->bank_name }}</b>
                                        </div>
                                    </div>
                                @endif

                                @if (!empty($info['transaction_info']['acquirer_transaction_id']))
                                    <div class="row" style="margin: 0 1%;">
                                        <div class="col-sm-6 text-right item"
                                            style="text-align: left; padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            Acquirer ID:</div>
                                        <div class="col-sm-6 text-left item"
                                            style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            <b>{{ $info['transaction_info']['acquirer_transaction_id'] }}</b>
                                        </div>
                                    </div>
                                @endif
