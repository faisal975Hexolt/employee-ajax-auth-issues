  ...
  @switch($business_type_id)
    ...
    @endif
        ...
        <input type="hidden" name="id" id="doc_id" value="{{!empty($docs_list->id)?$docs_list->id:''}}">
         <input type="hidden" id="merchant_id" name="merchant_id" value="{{$merchant_id}}">
         <input type="hidden" id="business_type_id" name="business_type_id" value="{{$business_type_id}}">
