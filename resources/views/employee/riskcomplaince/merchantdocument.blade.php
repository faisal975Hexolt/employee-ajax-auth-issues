...
@section('employeecontent')
                            ...
                            @foreach ($sublinks as $index => $value)
                                @if ($index == 0)
                                    <div id="{{ str_replace(' ', '-', strtolower($sublink_name)) }}"
                                        ...
                                        <div class="row padding-10">
                                            <div class="col-sm-12">
                                                ...
                                                <button type="button" style=" margin-bottom:5px;" class="btn btn-primary"
                                                    onclick="addMerchantModal()">Add Merchant</button>
                                            </div>
                                            <div class="col-sm-12">
                                        ...
                                        <!-- add merchant modal  -->
                                        <div class="modal fade add-merchant-modal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-lg .modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form id="add_merchant_form" method="post"
                                                            action="{{ route('add_merchant') }}"
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="row"
                                                                    ...
                                                                    <div class="col-12" id="personaldetails">
                                                                        <div class="">
                                                                            <h4
                                                                                style="border-left: 3px solid red; padding-left:3px;">
                                                                                Personal Details:</h4>
                                                                            ...
                                                                            <div class="form-group form-fit">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">Email:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                                ...
                                                                                <div class="row " style="margin-top:5px;">
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">Mobile:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                                    ...
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">Password:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                                        <input type="password"
                                                                    ...
                                                                    <div class="col-12" id="businessdetails"
                                                                        style="display:none;">
                                                                        <div class="">
                                                                            <h4
                                                                                style="border-left: 3px solid red; padding-left:3px;">
                                                                            ...
                                                                            <div class="form-group form-fit">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">Monthly
                                                                                        Expenditure:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">


                                                                                        <select name="monexpenditure"
                                                                                            id="monexpenditure"
                                                                                ...
                                                                                <div class="row"
                                                                                    ...
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">Pincode:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                                        <input type="text"
                                                                                            name="companypincode"
                                                                                ...
                                                                                <div class="row"
                                                                                    style="margin-top:5px;">
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">City:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                                        <input type="text"
                                                                                            name="city" id="c_city"
                                                                                    ...
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">State:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                    ...
                                                                    <div class="col-12" id="businessinfodetails"
                                                                        style="display:none;">
                                                                        <div class="">
                                                                            <h4
                                                                                style="border-left: 3px solid red; padding-left:3px;">
                                                                            ...
                                                                            <div class="form-group form-fit">
                                                                                ...
                                                                                <div class="row"
                                                                                    ...
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">WebApp/Url:<span
                                                                                            class="text-danger"></span></label>
                                                                                    <div class="col-sm-3">
                                                                                        <input type="text"
                                                                                            name="webapp_url"
                                                                    ...
                                                                    <div class="col-12" id="businessmoredetails"
                                                                        style="display:none;">
                                                                        <div class="">
                                                                            <h4
                                                                                style="border-left: 3px solid red; padding-left:3px;">
                                                                            ...
                                                                            <div class="form-group form-fit">
                                                                                ...
                                                                                <div class="row"
                                                                                    style="margin-top:5px;">
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">Authorized
                                                                                        Signatory PAN No:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                                        <input type="text"
                                                                                            name="authorized_sign_pan_no"
                                                                                            id="authorized_sign_pan_no"
                                                                                            class="form-control"
                                                                                            value=""
                                                                                            required="required">
                                                                                    </div>
                                                                                    ...
                                                                                    <label for="input"
                                                                                        class="col-sm-3 control-label">Authorized
                                                                                        Signatory Aadhar No:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-3">
                                                                                        <input type="text"
                                                                                            name="authorized_sign_aadhar_no"
                                                                                            id="authorized_sign_aadhar_no"
                                                                                            class="form-control"
                                                                                            value=""
                                                                                            required="required">
                                                                                    </div>
                                                                                ...
                                                                                <div class="row"
                                                                                    ...
                                                                                    <div class="col-sm-3">
                                                                                        <input type="text"
                                                                                            name="authorized_sign_name"
                                                                                            id="authorized_sign_name"
                                                                                            class="form-control"
                                                                                            value=""
                                                                                            required="required">
                                                                                    </div>
                                                                    ...
                                                                    <div class="col-12" id="uploadfiles"
                                                                        ...
                                                                        <div class="">
                                                                            ...
                                                                            <div class="text-center text-danger">
                                                                                Note:Pdfs & Images are only allowed up to
                                                                                5mb in size
                                                                            </div>
                                                                            <div id="case1">

                                                                                <div class=" row form-group"
                                                                                    id="file_comp_pan_card"
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_comp_pan_card">Company
                                                                                        Pancard: <span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            name="comp_pan_card"
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div id="file_comp_pan_card_error">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            name="comp_gst_doc"
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div id="file_comp_gst_error">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>

                                                                                <div class=" row form-group"
                                                                                    id="file_bank_statement"
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_bank_statement">Bank
                                                                                        Statement: <span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            ...
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div
                                                                                            id="file_bank_statement_error">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>

                                                                                <div class=" row form-group"
                                                                                    id="file_cancel_cheque"
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_cancel_cheque">Cancel
                                                                                        cheque: <span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            name="cancel_cheque"
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div id="file_cancel_cheque_error">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    id="file_cofincorporation"
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_cofincorporation">Certificate
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            ...
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div
                                                                                            id="file_cofincorporation_error">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    id="file_auth_sign_pancard"
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_auth_sign_pancard">Auth
                                                                                        signatory Pancard: <span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            name="mer_pan_card"
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div
                                                                                            id="file_auth_sign_pancard_error">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>

                                                                                <div class=" row form-group"
                                                                                    id="file_auth_sign_aadhar"
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_auth_sign_aadhar">Auth
                                                                                        signatory Aadhar card: <span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            name="mer_aadhar_card"
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div
                                                                                            id="file_auth_sign_aadhar_error">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    ...
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_partnership">Partnership
                                                                                        Deed:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    id="file_llp_agreeement"
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_llp_agreeement">LLP
                                                                                        Agreement:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    ...
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_registration">Registration:<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    ...
                                                                                    style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_trustdeed">Trust Deed/
                                                                                        Bye-laws/ Constitutional Document:
                                                                                        <span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                                            name="trust_constitutional"
                                                                                            class="inputfile form-control inputfile-2" />
                                                                                        <div id="file_cancel_cheque_error">
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class=" row form-group"
                                                                                    id="file_noc" style="display:none;">
                                                                                    <label class="control-label col-sm-4"
                                                                                        for="file_noc">No Objection
                                                                                        Certificate: <span
                                                                                            class="text-danger">*</span></label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="file"
                                                                    ...
                                                                    <div id="showerror"
                                                                        class="text-danger text-center my-3"></div>
                                ...
                                @else
                                    <div id="{{ str_replace(' ', '-', strtolower($value->link_name)) }}"
                                        ...
                                        <a class="btn btn-sm btn-success margin-right-lg margin-bottom-lg pull-right"
                                            data-toggle="modal" id="call-new-doc-add-modal">Add New Doc</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content modal-lg">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="add-extra-document-form" method="POST"
                                                                class="form-horizontal" role="form">
                                                                <div class="form-group">
                                                                    <label for="input"
                                                                        class="col-sm-2 control-label">Merchant:</label>
                                                                    <div class="col-sm-4">
                                                                        <select name="merchant_id" id="input"
                                                                            class="form-control">
                                                                ...
                                                                <div id="input-file-area" class="input-file-area">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label for="input"
                                                                            class="col-sm-2 control-label">File:</label>
                                                                        <div class="col-sm-3">
                                                                            <input type="file" name="doc_file[]"
                                                                                id="file-1"
                                                                                class="inputfile form-control inputfile-1"
                                                                                multiple />
                                                                            <label for="file-1"
    ...
    <script>
        addMerchant = "<?php echo $addMerchant; ?>";
        document.addEventListener('DOMContentLoaded', function() {
            getMerchantDocsDetails();
            if (addMerchant == 1) {
                addMerchantModal();
                $("#add_merchant_form")[0].reset()
            }
            ...
            if (button === 'next') {
                ...
                if (counter == 0) {
                    ...
                    $.ajax({
                        ...
                        url: '{{ route('validate_merchant_mail') }}',
                        data: {
                            username: email,
                            for: 'mail'
                        },
                    ...
                    $("#next").text('Validating Mobile Number');
                ...
                if (counter == 3) {
                    ...
                    if (company_pan_no.length == 0 || company_gst.length == 0 || authorized_sign_pan_no.length ==
                        0 || authorized_sign_aadhar_no.length == 0 || authorized_sign_name.length == 0) {
                        console.log('please fill all the fields');
                        $('#showerror').html('Please fill all the fields');
                        return false;
                    }
    ...
    <script>
        function validator() {
            ...
            if (business_type == 1) {
                ...
                if (compPanCard.length == 0 || compGst.length == 0 || bankStatement.length == 0 || cancelCheque.length ==
                    0 || cofincorporation.length == 0 || moa.length == 0 || aoa.length == 0 || authSignPancard.length ==
                    0 || authSignAadhar.length == 0) {
                ...
                if (compGst.length == 0 || bankStatement.length == 0 || cancelCheque.length == 0 || authSignPancard
                    .length == 0 || authSignAadhar.length == 0) {
                    $('#showerror').html('Please Upload All Files');
                    return false;
                }
                ...
                if (compPanCard.length == 0 || compGst.length == 0 || bankStatement.length == 0 || cancelCheque.length ==
                    0 || partnership.length == 0 || authSignPancard.length == 0 || authSignAadhar.length == 0) {
                    $('#showerror').html('Please Upload All Files');
                    return false;
                }
                ...
                if (compPanCard.length == 0 || compGst.length == 0 || bankStatement.length == 0 || cancelCheque.length ==
                    0 || cofincorporation.length == 0 || moa.length == 0 || aoa.length == 0 || authSignPancard.length ==
                    0 || authSignAadhar.length == 0 || partnership.length == 0) {
                    $('#showerror').html('Please Upload All Files');
                    return false;
                }
                ...
                if (compPanCard.length == 0 || compGst.length == 0 || bankStatement.length == 0 || cancelCheque.length ==
                    0 || llp.length == 0 || cofincorporation.length == 0 || authSignPancard.length == 0 || authSignAadhar
                    .length == 0) {
                    $('#showerror').html('Please Upload All Files');
                    return false;
                }
                ...
                if (compPanCard.length == 0 || registration.length == 0 || trustDeed.length == 0 || noc.length == 0 ||
                    authSignPancard.length == 0 || authSignAadhar.length == 0) {
                    $('#showerror').html('Please Upload All Files');
                    return false;
                }
            }

            console.log('%cmerchantdocument.blade.php line:1083 Object', 'color: white; background-color: #007acc;',
                'REached');
            $('#showerror').html('');
