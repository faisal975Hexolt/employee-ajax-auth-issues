    ...
    <div class="col-sm-4">
        <div class="row">
            <div class="case-details">
                <a href="{{route('risk-complaince-payable','paysel-MMsTfgSk')}}" class="btn btn-primary pull-right">Go
                    Back</a>
                ...
                <p class="p"><strong class="strong">Transaction
                        Amount:</strong>&nbsp;{{$case_details->transaction_amount}}</p>
                <p class="p"><strong class="strong">Customer Reason:</strong>&nbsp;{{$case_details->customer_reason}}
                </p>
                ...
                <div style="margin-right:10px;margin-bottom:10px;">
                    <a href="{{asset('storage/uploads/'.$case_details->transaction_proof)}}" target="_blank"> <img
                            id="CasetransactionProof" width="400" height="400"
                            src="{{asset('storage/uploads/'.$case_details->transaction_proof)}}"></a>
                </div>
                </p>
            </div>
        </div>
                ...
                <div class="search">
                    <div class="chat">
                        ...
                        <div class="chat-message">
                            ...
                            <form id="managepay-comment-form">
                                <textarea name="comment" id="message-to-send" placeholder="Type your message" rows="2"
                                    cols="90" style="width: 70%;"></textarea>
                                {{csrf_field()}}
                                <input type="hidden" name="commented_user" id="commented_user"
                                    value="{{ ucfirst(auth()->guard('employee')->user()->first_name.' '.auth()->guard('employee')->user()->last_name) }}">
