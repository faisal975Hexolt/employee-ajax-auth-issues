...
<head>
    ...
    <title>{{ config('app.name', 'S2Payment') }}</title>
    ...
    <div class="container">
        <div class="navbar-header bg-transparent">
            ...
            <a target="_blank" href="#" class="navbar-brand">
                <img src="{{asset('images/'.$logoPath->path)}}" alt="logo" width="100" alt="">
            </a>
        </div>
                        ...
                        <li>
                            <div class="navbar-login">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <p class="text-center">
                                            <img src="{{ asset('assets/img/navbar-user.png') }}" width="80"
                                                alt="">
                                        </p>
                                    </div>
                                    <div class="col-lg-8">
                                        <p class="text-left">
                                            <strong>{{ Auth::guard('employee')->user()->first_name . ' ' . Auth::guard('employee')->user()->last_name }}
                                            </strong></p>
                                        <p class="text-left small">
                                            {{ Auth::guard('employee')->user()->official_email }} </p>
                                    </div>
                                </div>
                            </div>
                        </li>
...
<!-- my nav -->
<div class="bdy-55">
    <img class="wave-55" src="{{ asset('assets/img/intro-capital.jpg') }}">
    <div class="container-55">
        <div class="img-55">
            <img src="{{ asset('assets/img/authen.svg') }}">
        </div>
        <div class="login-content-55">
            <form action="{{ route('emp-session-update') }}" class="form-55" method="POST">
                <img src="{{ asset('assets/img/f-prt.svg') }}">
