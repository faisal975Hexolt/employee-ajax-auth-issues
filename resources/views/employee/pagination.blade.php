@php
    ...
    $emp->payable_manage = ['1' => 'Supplier Order based Invoice', '2' => 'Supplier Direct Invoice', '3' => 'Debit Note/ Credit Note'];
    $emp->receivable_manage = ['1' => 'Order based sale Invoice', '2' => 'Customer Debit Note/ Credit Note'];
                ...
                @if (count($employees) > 0)
                    @foreach ($employees as $index => $employee)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td><a
                                    href="{{ route('edit.employee', $employee->id) }}">{{ $employee->employee_username }}</a>
                            </td>
                            ...
                            @if (auth()->guard('employee')->user()->user_type == '1')
                                <td><a href="/manage/hrm/employee-accesses/{{ $employee->id }}"
                                        class="btn btn-primary btn-sm">Access</a>
                                    <a href="javascript:deleteEmployee('{{ $employee->id }}','{{ urlencode($employee->full_name) }}')"
...
@if ($module == 'accountchart')
    @if (isset($accountcharts))
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $accountcharts->firstItem() == '' ? '0' : $accountcharts->firstItem() }} to
                    {{ $accountcharts->lastItem() == '' ? '0' : $accountcharts->lastItem() }} of
                    {{ $accountcharts->total() }} entries</h5>
            </div>
...
@if ($module == 'invoice')
    @if (isset($invoices))
        ...
        <div class="table-responsive">
                        ...
                        @foreach ($invoices as $invoice)
                            <tr>
                                ...
                                @if ($invoice->invoice_status == 'saved')
                                    <td>
                                        <a
                                            href="{{ route('edit-invoice', $invoice->id) }}">{{ $invoice->invoice_gid }}</a>
                                    </td>
                                @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $invoices->firstItem() == '' ? '0' : $invoices->firstItem() }} to
                    {{ $invoices->lastItem() == '' ? '0' : $invoices->lastItem() }} of {{ $invoices->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'item')
    @if (isset($items))
        ...
        <div class="table-responsive">
                ...
                <tbody id="itemtable">
                    @if (count($items) > 0)
                        @foreach ($items as $item)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:editItem('{{ $item->id }}');">{{ $item->item_gid }}</a>
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-danger btn-xs"
                                        href="javascript:deleteItem('{{ $item->id }}')">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $items->firstItem() == '' ? '0' : $items->firstItem() }} to
                    {{ $items->lastItem() == '' ? '0' : $items->lastItem() }} of {{ $items->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'customer')
    @if (isset($customers))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($customers) > 0)
                        @foreach ($customers as $customer)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="javascript:editCustomer('{{ $customer->id }}');">{{ $customer->customer_gid }}</a>
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-danger btn-xs"
                                        href="javascript:deleteCustomer('{{ $customer->id }}')">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $customers->firstItem() == '' ? '0' : $customers->firstItem() }} to
                    {{ $customers->lastItem() == '' ? '0' : $customers->lastItem() }} of {{ $customers->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'merchantsupport')
    @if (isset($merchantsupports))
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $merchantsupports->firstItem() == '' ? '0' : $merchantsupports->firstItem() }} to
                    {{ $merchantsupports->lastItem() == '' ? '0' : $merchantsupports->lastItem() }} of
                    {{ $merchantsupports->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'merchantlist')
    @if (isset($merchantlists))
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $merchantlists->firstItem() == '' ? '0' : $merchantlists->firstItem() }} to
                    {{ $merchantlists->lastItem() == '' ? '0' : $merchantlists->lastItem() }} of
                    {{ $merchantlists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'merchantcallsupport')
    @if (isset($merchantcallsupports))
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $merchantcallsupports->firstItem() == '' ? '0' : $merchantcallsupports->firstItem() }} to
                    {{ $merchantcallsupports->lastItem() == '' ? '0' : $merchantcallsupports->lastItem() }} of
                    {{ $merchantcallsupports->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'leadsaleslist')
    @if (isset($leadsaleslists))
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th>Sno</th>
                        @if (auth()->guard('employee')->user()->user_type == '1' ||
                                auth()->guard('employee')->user()->user_type == '15')
                            <th>
                                <div class="checkbox">
                                    <label>
                        ...
                        @foreach ($leadsaleslists as $leadsaleslist)
                            <tr>
                                ...
                                <td><a href="javascript:"
                                        onclick="editLeadSale('{{ $leadsaleslist->id }}');">{{ $leadsaleslist->merchant_name }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $leadsaleslists->firstItem() == '' ? '0' : $leadsaleslists->firstItem() }} to
                    {{ $leadsaleslists->lastItem() == '' ? '0' : $leadsaleslists->lastItem() }} of
                    {{ $leadsaleslists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'dailysaleslist')
    @if (isset($dailysaleslists))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($dailysaleslists) > 0)
                        ...
                        @foreach ($dailysaleslists as $dailysaleslist)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editDailySale('{{ $dailysaleslist->id }}');">{{ $dailysaleslist->merchant_name }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $dailysaleslists->firstItem() == '' ? '0' : $dailysaleslists->firstItem() }} to
                    {{ $dailysaleslists->lastItem() == '' ? '0' : $dailysaleslists->lastItem() }} of
                    {{ $dailysaleslists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'saleslist')
    @if (isset($saleslists))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($saleslists) > 0)
                        ...
                        @foreach ($saleslists as $saleslist)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editSale('{{ $saleslist->id }}');">{{ $saleslist->merchant_name }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $saleslists->firstItem() == '' ? '0' : $saleslists->firstItem() }} to
                    {{ $saleslists->lastItem() == '' ? '0' : $saleslists->lastItem() }} of {{ $saleslists->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'fieldleadlist')
    @if (isset($fieldleadlists))
        @php($table_count = 0)
        <div class="table-responsive">
            <table class="table table-bordered text-nowrap1">
                <thead>
                    <tr>
                        <th>Sno</th>
                        <th>Merchant Gid</th>
                        ...
                        @foreach ($fieldleadlists as $fieldleadlist)
                            <tr>
                                ...
                                <td><a href="javascript:void(0)"
                                        onclick="getTransactionBreakUp('{{ $fieldleadlist->id }}');">
                                        {{ $fieldleadlist->merchant_gid }}</a></td>
                                <td><?= wordwrap($fieldleadlist->business_name, 30, "<br>\n") ?></td>
                                <td><?= wordwrap($fieldleadlist->name, 30, "<br>\n") ?></td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $fieldleadlists->firstItem() == '' ? '0' : $fieldleadlists->firstItem() }} to
                    {{ $fieldleadlists->lastItem() == '' ? '0' : $fieldleadlists->lastItem() }} of
                    {{ $fieldleadlists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    <li><a href="{{ URL::to($fieldleadlists->previousPageUrl()) }}">Previous</a></li>
                    <li><a href="javascript:">{{ $fieldleadlists->currentPage() }}</a></li>
                    <li><a href=" {{ URL::to($fieldleadlists->nextPageUrl()) }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'fielddailylist')
    @if (isset($fielddailylists))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($fielddailylists) > 0)
                        ...
                        @foreach ($fielddailylists as $fielddailylist)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editFieldSale('{{ $fielddailylist->id }}')">{{ $fielddailylist->merchant_name }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $fielddailylists->firstItem() == '' ? '0' : $fielddailylists->firstItem() }} to
                    {{ $fielddailylists->lastItem() == '' ? '0' : $fielddailylists->lastItem() }} of
                    {{ $fielddailylists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'fieldsaleslist')
    @if (isset($fieldsaleslists))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($fieldsaleslists) > 0)
                        ...
                        @foreach ($fieldsaleslists as $fieldsaleslist)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editFieldSale('{{ $fieldsaleslist->id }}')">{{ $fieldsaleslist->merchant_name }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $fieldsaleslists->firstItem() == '' ? '0' : $fieldsaleslists->firstItem() }} to
                    {{ $fieldsaleslists->lastItem() == '' ? '0' : $fieldsaleslists->lastItem() }} of
                    {{ $fieldsaleslists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'paysliplist')
    @if (isset($paysliplists))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($paysliplists) > 0)
                        ...
                        @foreach ($paysliplists as $paysliplist)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-payslip', $paysliplist->id) }}">{{ $paysliplist->full_name }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $paysliplists->firstItem() == '' ? '0' : $paysliplists->firstItem() }} to
                    {{ $paysliplists->lastItem() == '' ? '0' : $paysliplists->lastItem() }} of
                    {{ $paysliplists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'nooftransaction')
    @if (isset($nooftransactions))
        ...
        <div class="table-responsive">
            <table class="table table-bordered text-nowrap">
                <thead>
                    <tr>
                        ...
                        <th>Merchant <br>Id</th>
                        <!--  <th>Email</th>
                <th>Mobile</th> -->
                        <th>Total No Of <br>Transactions</th>
                        <th>No Of Authorized <br>Transaction</th>
                        <th>No Of Successful <br>Transaction</th>
                        <th>No Of Failed <br>Transaction</th>
                        <th>Success <br>Ratio</th>
                    </tr>
                </thead>
                <tbody id="nooftransactiontable">
                    @if (count($nooftransactions) > 0)
                        ...
                        @foreach ($nooftransactions as $nooftransaction)
                            @php($number = ($nooftransaction->no_of_success / $nooftransaction->no_of_transaction) * 100)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td>{{ $nooftransaction->name }}</a> </td>
                                <td>{{ $nooftransaction->merchant_gid }}</td>
                                <!--   <td>{{ $nooftransaction->email }}</td>
                <td>{{ $nooftransaction->mobile_no }}</td> -->
                                <td style="color: green;text-align: center;">
                                    {{ $nooftransaction->no_of_transaction }}</td>
                                <td style="color: violet;text-align: center;">
                                    {{ $nooftransaction->no_of_authorized }}</td>
                                <td style="color: blue;text-align: center;">{{ $nooftransaction->no_of_success }}
                                </td>
                                <td style="color: red;text-align: center;">{{ $nooftransaction->no_of_failed }}</td>
                                <td>{{ number_format((float) $number, 2, '.', '') }} </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $nooftransactions->firstItem() == '' ? '0' : $nooftransactions->firstItem() }} to
                    {{ $nooftransactions->lastItem() == '' ? '0' : $nooftransactions->lastItem() }} of
                    {{ $nooftransactions->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'transactionamount')
    @if (isset($transactionamounts))
        ...
        <div class="table-responsive">
                ...
                <tbody id="transactionamounttable">
                    @if (count($transactionamounts) > 0)
                        ...
                        @foreach ($transactionamounts as $transactionamount)
                            <tr>
                                <td style="color: black;text-align: center;">{{ ++$table_count }}</td>
                                <td style="color: black;">{{ $transactionamount->name }}</a> </td>
                                <td style="color: black;text-align: center;">{{ $transactionamount->merchant_gid }}
                                </td>
                                <!-- <td>{{ $transactionamount->email }}</td>
                <td>{{ $transactionamount->mobile_no }}</td> -->
                                <td style="color: black;text-align: center;">
                                    &#8377;{{ number_format($transactionamount->transaction_amount, 2) }}</td>
                                <td style="color: black;text-align: center;">
                                    &#8377;{{ number_format($transactionamount->adjustment_charged_amount, 2) }}</td>

                                <td style="color: black;text-align: center;">
                                    &#8377;{{ number_format($transactionamount->gst_charged_amount, 2) }}</td>

                                <td style="color: black;text-align: center;">
                                    &#8377;{{ number_format($transactionamount->total_charged_amount, 2) }}</td>
                                <td style="color: black;text-align: center;">
                                    &#8377;{{ number_format($transactionamount->total_adjustment, 2) }}</td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $transactionamounts->firstItem() == '' ? '0' : $transactionamounts->firstItem() }} to
                    {{ $transactionamounts->lastItem() == '' ? '0' : $transactionamounts->lastItem() }} of
                    {{ $transactionamounts->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'merchant')
    @if (isset($merchants))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($merchants) > 0)
                        ...
                        @foreach ($merchants as $merchant)
                            <tr>
                                ...
                                <td>{{ $merchant->merchant_gid }}</a> </td>
                                <td>{{ $merchant->email }}</td>
                                <td>{{ $merchant->mobile_no }}</td>

                                <td>{{ \Carbon\Carbon::parse($merchant->created_date)->format('M d, Y H:m:s') }} </td>
                                <td>{{ \Carbon\Carbon::parse($merchant->last_seen_at)->format('M d, Y H:m:s') }} </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $merchants->firstItem() == '' ? '0' : $merchants->firstItem() }} to
                    {{ $merchants->lastItem() == '' ? '0' : $merchants->lastItem() }} of {{ $merchants->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'case')
    @if (isset($cases))
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $cases->firstItem() == '' ? '0' : $cases->firstItem() }} to
                    {{ $cases->lastItem() == '' ? '0' : $cases->lastItem() }} of {{ $cases->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'loginactivity')
    @if (isset($loginactivities))
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody id="loginactivitytable">
                    @if (count($loginactivities) > 0)
                        <?php $rowc = $loginactivities->firstItem(); ?>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $loginactivities->firstItem() == '' ? '0' : $loginactivities->firstItem() }} to
                    {{ $loginactivities->lastItem() == '' ? '0' : $loginactivities->lastItem() }} of
                    {{ $loginactivities->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    <li><a href="{{ URL::to($loginactivities->previousPageUrl()) }}">Previous</a></li>
                    <li><a href="javascript:">{{ $loginactivities->currentPage() }}</a></li>
                    <li><a href="{{ URL::to($loginactivities->nextPageUrl()) }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'lockedmerchant')
    @if (isset($lockedmerchants))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($lockedmerchants) > 0)
                        ...
                        @foreach ($lockedmerchants as $lockedmerchant)
                            <tr>
                                ...
                                <td><a href="javascript:void(0)" class="btn btn-sm btn-success"
                                        onclick="unlockMerchantAccount('{{ $lockedmerchant->id }}');">Unlock</a></td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $lockedmerchants->firstItem() == '' ? '0' : $lockedmerchants->firstItem() }} to
                    {{ $lockedmerchants->lastItem() == '' ? '0' : $lockedmerchants->lastItem() }} of
                    {{ $lockedmerchants->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'noofpaylink')
    @if (isset($noofpaylinks))
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $noofpaylinks->firstItem() == '' ? '0' : $noofpaylinks->firstItem() }} to
                    {{ $noofpaylinks->lastItem() == '' ? '0' : $noofpaylinks->lastItem() }} of
                    {{ $noofpaylinks->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'noofinvoice')
    @if (isset($noofinvoices))
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $noofinvoices->firstItem() == '' ? '0' : $noofinvoices->firstItem() }} to
                    {{ $noofinvoices->lastItem() == '' ? '0' : $noofinvoices->lastItem() }} of
                    {{ $noofinvoices->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'blogpost')
    @if (isset($blogposts))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($blogposts) > 0)
                        @foreach ($blogposts as $blogpost)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editPost('{{ $blogpost->id }}')">{{ $blogpost->title }}</a></a>
                                </td>
                                <td>{{ $blogpost->created_date }}</td>
                                <td>{{ $blogpost->created_user }}</td>
                                <td><a href="javascript:" onclick="callRemovePostModel('{{ $blogpost->id }}')"
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $blogposts->firstItem() == '' ? '0' : $blogposts->firstItem() }} to
                    {{ $blogposts->lastItem() == '' ? '0' : $blogposts->lastItem() }} of {{ $blogposts->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'csrpost')
    @if (isset($csrposts))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($csrposts) > 0)
                        @foreach ($csrposts as $csrpost)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editCSRPost('{{ $csrpost->id }}')">{{ $csrpost->title }}</a></a>
                                </td>
                                <td>{{ $csrpost->created_date }}</td>
                                <td>{{ $csrpost->created_user }}</td>
                                <td><a href="javascript:" onclick="callRemoveCSRPostModel('{{ $csrpost->id }}')"
                                        class="btn btn-sm btn-danger">Delete</a></td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $csrposts->firstItem() == '' ? '0' : $csrposts->firstItem() }} to
                    {{ $csrposts->lastItem() == '' ? '0' : $csrposts->lastItem() }} of {{ $csrposts->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'prpost')
    @if (isset($prposts))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($prposts) > 0)
                        @foreach ($prposts as $prpost)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editPRPost('{{ $prpost->id }}')">{{ $prpost->title }}</a></a>
                                </td>
                                <td>{{ $prpost->created_date }}</td>
                                <td>{{ $prpost->created_user }}</td>
                                <td><a href="javascript:" onclick="callRemovePRPostModel('{{ $prpost->id }}')"
                                        class="btn btn-sm btn-danger">Delete</a></td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $prposts->firstItem() == '' ? '0' : $prposts->firstItem() }} to
                    {{ $prposts->lastItem() == '' ? '0' : $prposts->lastItem() }} of {{ $prposts->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'eventpost')
    @if (isset($eventposts))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($eventposts) > 0)
                        @foreach ($eventposts as $eventpost)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editEventPost('{{ $eventpost->id }}')">{{ $eventpost->event_name }}</a></a>
                                </td>
                                ...
                                <td><a href="javascript:" onclick="callRemoveEventPostModel('{{ $eventpost->id }}')"
                                        class="btn btn-sm btn-danger">Delete</a></td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $eventposts->firstItem() == '' ? '0' : $eventposts->firstItem() }} to
                    {{ $eventposts->lastItem() == '' ? '0' : $eventposts->lastItem() }} of {{ $eventposts->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'asset')
    @if (isset($assets))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($assets) > 0)
                        @foreach ($assets as $asset)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editAsset('{{ $asset->id }}')">{{ $asset->asset_gid }}</a></a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $assets->firstItem() == '' ? '0' : $assets->firstItem() }} to
                    {{ $assets->lastItem() == '' ? '0' : $assets->lastItem() }} of {{ $assets->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'capitalasset')
    @if (isset($capitalassets))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($capitalassets) > 0)
                        @foreach ($capitalassets as $capitalasset)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editCapitalasset('{{ $capitalasset->id }}')">{{ $capitalasset->asset_gid }}</a></a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $capitalassets->firstItem() == '' ? '0' : $capitalassets->firstItem() }}
                    to {{ $capitalassets->lastItem() == '' ? '0' : $capitalassets->lastItem() }} of
                    {{ $capitalassets->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'depreciateasset')
    @if (isset($depreciateassets))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($depreciateassets) > 0)
                        @foreach ($depreciateassets as $depreciateasset)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editDepreciate('{{ $depreciateasset->id }}')">{{ $depreciateasset->asset_gid }}</a></a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $depreciateassets->firstItem() == '' ? '0' : $depreciateassets->firstItem() }} to
                    {{ $depreciateassets->lastItem() == '' ? '0' : $depreciateassets->lastItem() }} of
                    {{ $depreciateassets->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'saleasset')
    @if (isset($saleassets))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($saleassets) > 0)
                        @foreach ($saleassets as $saleasset)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editSale('{{ $saleasset->id }}')">{{ $saleasset->asset_gid }}</a></a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $saleassets->firstItem() == '' ? '0' : $saleassets->firstItem() }} to
                    {{ $saleassets->lastItem() == '' ? '0' : $saleassets->lastItem() }} of {{ $saleassets->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'voucher')
    @if (isset($vouchers))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($vouchers) > 0)
                        @foreach ($vouchers as $voucher)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:"
                                        onclick="editVoucher('{{ $voucher->id }}')">{{ $voucher->voucher_no == '' ? 'voucherid' : $voucher->voucher_no }}</a></a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $vouchers->firstItem() == '' ? '0' : $vouchers->firstItem() }} to
                    {{ $vouchers->lastItem() == '' ? '0' : $vouchers->lastItem() }} of {{ $vouchers->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'supplier')
    @if (isset($suppliers))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($suppliers) > 0)
                        @foreach ($suppliers as $supplier)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="javascript:editSupplier('{{ $supplier->id }}');">{{ $supplier->supplier_gid }}</a>
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-danger btn-xs"
                                        href="javascript:deleteSupplier('{{ $supplier->id }}')">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $suppliers->firstItem() == '' ? '0' : $suppliers->firstItem() }} to
                    {{ $suppliers->lastItem() == '' ? '0' : $suppliers->lastItem() }} of {{ $suppliers->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'porder')
    @if (isset($porders))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($porders) > 0)
                        @foreach ($porders as $porder)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-purchase-order', $porder->id) }}">{{ empty($porder->porder_no) ? 'purchaseId' : $porder->porder_no }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $porders->firstItem() == '' ? '0' : $porders->firstItem() }} to
                    {{ $porders->lastItem() == '' ? '0' : $porders->lastItem() }} of {{ $porders->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'ryapay_adjustment')
    @if (isset($ryapay_adjustments))
        ...
        <div class="table-responsive">
                            ...
                            <tr>
                                <td>
                                    <div class="checkbox"><label><input type="checkbox" name="id[]"
                                                id="id" value="{{ $ryapay_adjustment->id }}"
                                                class="form-control" onclick="getBulkAdjsutmentIds(this)"
                                                {{ $ryapay_adjustment->adjustment_status == 'processed' ? 'disabled' : '' }}>
                                            <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                        </label></div>
                                </td>
                                <td>{{ ++$table_count }}</td>
                                ...
                                <td><a href="javascript:void(0)"
                                        onclick="merchantAdjustment('{{ $ryapay_adjustment->id }}','{{ $ryapay_adjustment->merchant_id }}')"
                                        class="btn btn-success btn-sm text-center">Proceed <br>to<br> merchant</button>
                                </td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $ryapay_adjustments->firstItem() == '' ? '0' : $ryapay_adjustments->firstItem() }} to
                    {{ $ryapay_adjustments->lastItem() == '' ? '0' : $ryapay_adjustments->lastItem() }} of
                    {{ $ryapay_adjustments->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'taxsettlement')
    @if (isset($taxsettlements))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($taxsettlements) > 0)
                        @foreach ($taxsettlements as $taxsettlement)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:void(0)"
                                        onclick="editTaxSettlement('{{ $taxsettlement->id }}')">{{ $taxsettlement->tax_type }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $taxsettlements->firstItem() == '' ? '0' : $taxsettlements->firstItem() }} to
                    {{ $taxsettlements->lastItem() == '' ? '0' : $taxsettlements->lastItem() }} of
                    {{ $taxsettlements->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'taxadjustment')
    @if (isset($taxadjustments))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($taxadjustments) > 0)
                        ...
                        @foreach ($taxadjustments as $taxadjustment)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:void(0)"
                                        onclick="editTaxSettlement('{{ $taxadjustment->id }}')">{{ $taxadjustment->tax_type }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $taxadjustments->firstItem() == '' ? '0' : $taxadjustments->firstItem() }} to
                    {{ $taxadjustments->lastItem() == '' ? '0' : $taxadjustments->lastItem() }} of
                    {{ $taxadjustments->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'taxpayment')
    @if (isset($taxpayments))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($taxpayments) > 0)
                        ...
                        @foreach ($taxpayments as $taxpayment)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:void(0)"
                                        onclick="editTaxSettlement('{{ $taxpayment->id }}')">{{ $taxpayment->tax_type }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $taxpayments->firstItem() == '' ? '0' : $taxpayments->firstItem() }} to
                    {{ $taxpayments->lastItem() == '' ? '0' : $taxpayments->lastItem() }} of
                    {{ $taxpayments->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'adjustment_report')
    @if (isset($adjustment_reports))
        @php($table_count = 0)
        <div id="adjustment-report-ajax-error-response" class="text-center text-danger padding-10">
            {{ $error_message }}</div>
        <div id="adjustment-report-ajax-success-response" class="text-center text-success padding-10">
            {{ $success_message }}</div>
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    ...
                    @if (count($adjustment_reports) > 0)
                        ...
                        @foreach ($adjustment_reports as $index => $adjustment_report)
                            <tr>
                                ...
                                <td><input type="text" name="basic_amount" id="basic_amount" class="form-control"
                                        value="{{ $adjustment_report['basic_amount'] }}"></td>
        ...
        <tr id="supord_item_row_{{ $index + 1 }}" data-row="{{ $index + 1 }}">
            ...
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <select name="item_id[]" id="suporder_item_name_{{ $index + 1 }}" class="form-control"
                            onchange="setSupOrderItemPrice('{{ $index + 1 }}',this);">
            ...
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="text" name="item_amount[]" id="suporder_item_price_{{ $index + 1 }}"
                            class="form-control" value="{{ $item->item_amount }}">
                    </div>
                </div>
            </td>
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="number" name="item_quantity[]" id="suporder_item_qty_{{ $index + 1 }}"
                            class="form-control" min="1" onchange="loadSuporderItemtotal();"
            ...
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="text" name="item_total[]" id="suporder_item_total_{{ $index + 1 }}"
                            class="form-control" value="{{ $item->item_total }}">
                    </div>
                </div>
            </td>
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <i class="fa fa-times fa-lg text-danger show-pointer"
                            id="suporder_item_remove_{{ $index + 1 }}"
                            onclick="supordRemoveItem('{{ $index + 1 }}')"></i>
                    </div>
                </div>
            </td>
        </tr>
...
@if ($module == 'suporder')
    @if (isset($suporders))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($suporders) > 0)
                        @foreach ($suporders as $suporder)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-suporder-invoice', $suporder->id) }}">{{ $suporder->porder_no }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $suporders->firstItem() == '' ? '0' : $suporders->firstItem() }} to
                    {{ $suporders->lastItem() == '' ? '0' : $suporders->lastItem() }} of {{ $suporders->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'supexp')
    @if (isset($supexps))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($supexps) > 0)
                        @foreach ($supexps as $supexp)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-supexp-invoice', $supexp->id) }}">{{ $supexp->supexp_invno }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $supexps->firstItem() == '' ? '0' : $supexps->firstItem() }} to
                    {{ $supexps->lastItem() == '' ? '0' : $supexps->lastItem() }} of {{ $supexps->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'supnote')
    @if (isset($supnotes))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($supnotes) > 0)
                        @foreach ($supnotes as $supnote)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-supcd-note', $supnote->id) }}">{{ $supnote->note_number }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $supnotes->firstItem() == '' ? '0' : $supnotes->firstItem() }} to
                    {{ $supnotes->lastItem() == '' ? '0' : $supnotes->lastItem() }} of {{ $supnotes->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'custnote')
    @if (isset($custnotes))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($custnotes) > 0)
                        @foreach ($custnotes as $custnote)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-custcd-note', $custnote->id) }}">{{ $custnote->note_number }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $custnotes->firstItem() == '' ? '0' : $custnotes->firstItem() }} to
                    {{ $custnotes->lastItem() == '' ? '0' : $custnotes->lastItem() }} of {{ $custnotes->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'sorder')
    @if (isset($sorders))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($sorders) > 0)
                        @foreach ($sorders as $sorder)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-sales-order', $sorder->id) }}">{{ empty($sorder->sorder_no) ? 'salesorderId' : $sorder->sorder_no }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $sorders->firstItem() == '' ? '0' : $sorders->firstItem() }} to
                    {{ $sorders->lastItem() == '' ? '0' : $sorders->lastItem() }} of {{ $sorders->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'custorder')
    @if (isset($custorders))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($custorders) > 0)
                        @foreach ($custorders as $custorder)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-custorder-invoice', $custorder->id) }}">{{ $custorder->sorder_no }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $custorders->firstItem() == '' ? '0' : $custorders->firstItem() }} to
                    {{ $custorders->lastItem() == '' ? '0' : $custorders->lastItem() }} of {{ $custorders->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
    ...
    @foreach ($sorder_items as $index => $item)
        <tr id="custord_item_row_{{ $index + 1 }}" data-row="{{ $index + 1 }}">
            ...
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <select name="item_id[]" id="custorder_item_name_{{ $index + 1 }}" class="form-control"
                            onchange="setCustOrderItemPrice('{{ $index + 1 }}',this);">
                            @foreach ($item_options as $options)
                                @if ($options->id == $item->item_id)
                                    <option value="{{ $options->id }}" selected>{{ $options->item_name }}</option>
                                @else
            ...
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="text" name="item_amount[]" id="custorder_item_price_{{ $index + 1 }}"
                            class="form-control" value="{{ $item->item_amount }}">
                    </div>
                </div>
            </td>
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="number" name="item_quantity[]" id="custorder_item_qty_{{ $index + 1 }}"
                            class="form-control" min="1" onchange="loadCustorderItemtotal();"
                            value="{{ $item->item_quantity }}">
                    </div>
                </div>
            </td>
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="text" name="item_total[]" id="custorder_item_total_{{ $index + 1 }}"
                            class="form-control" value="{{ $item->item_total }}">
                    </div>
                </div>
            </td>
            <td>
                <div class="form-group">
                    <div class="col-sm-12">
                        <i class="fa fa-times fa-lg text-danger show-pointer"
                            id="custorder_item_remove_{{ $index + 1 }}"
                            onclick="custordRemoveItem('{{ $index + 1 }}')"></i>
                    </div>
                </div>
            </td>
        </tr>
...
@if ($module == 'bginfo')
    @if (isset($bginfos))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($bginfos) > 0)
                        @foreach ($bginfos as $bginfo)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a
                                        href="{{ route('edit-verify-merchant', $bginfo->id) }}">{{ $bginfo->name }}</a>
                                </td>
                                <td>{{ $bginfo->email }}</td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $bginfos->firstItem() == '' ? '0' : $bginfos->firstItem() }} to
                    {{ $bginfos->lastItem() == '' ? '0' : $bginfos->lastItem() }} of {{ $bginfos->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'document')
    @if (isset($documents))
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody id="bginfotable">
                    @if (count($documents) > 0)
                        @inject('mDocumeent', 'App\MerchantDocument')

                        <?php $rowc = $documents->firstItem(); ?>
                        @foreach ($documents as $key => $document)
                            @if (1)
                                <tr>
                                    <td>{{ $rowc++ }}</td>
                                    <td><a href="javascript:void(0)"
                                            onclick="verifyMerchantDetails('{{ $document->merchant_id }}');">{{ $document->merchant_gid }}</a>
                                    </td>
                                    <td>{{ $document->name }}</td>
                                    <td>{{ $document->business_name }}</td>
                                    <td>{{ $document->type_name }}</td>
                                    <td>{{ ucwords($document->verified_status) }}</td>
                                    <td>{{ \Carbon\Carbon::parse($document->created_date)->format('M d, Y h:i:s A') }}
                                    </td>
                                    @if (
                                        $mDocumeent->find_merchant_business($document->merchant_id) &&
                                            $mDocumeent->find_merchant_document($document->merchant_id))
                                        @if ($document->verified_status == 'pending')
                                            <td><a href="{{ route('new-merchant-doc', $document->merchant_id) }}"
                                                    class="btn btn-primary btn-sm">Verify</a></td>
                                        @elseif($document->verified_status == 'correction')
                                            <td><a href="javascript:void(0);" class="btn btn-danger btn-sm">Under
                                                    Correction</a></td>
                                        @else
                                            <td><a href="{{ route('show_merchant_docs', $document->merchant_id) }}"
                                                    class="btn btn-success btn-sm">Verified</a></td>
                                        @endif
                                    @else
                                        <td><a href="#" disabled="disabled" class="btn btn-success btn-sm">No
                                                Uploaded</a></td>
                                    @endif
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $documents->firstItem() == '' ? '0' : $documents->firstItem() }} to
                    {{ $documents->lastItem() == '' ? '0' : $documents->lastItem() }} of {{ $documents->total() }}
                    entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    ...
                    <li><a href="{{ URL::to('/') }}{{ $documents->nextPageUrl() }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'custcase')
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody id="customertable">
                @if (count($custcases) > 0)
                    <?php $rowc = $custcases->firstItem(); ?>
                    @foreach ($custcases as $custcase)
                        <tr>
                            <td>{{ $rowc++ }}</td>
                            <td><a
                                    href="{{ route('get-case-details', $custcase->managepay_caseid) }}">{{ $custcase->case_gid }}</a>
                            </td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $custcases->firstItem() == '' ? '0' : $custcases->firstItem() }} to
                {{ $custcases->lastItem() == '' ? '0' : $custcases->lastItem() }} of {{ $custcases->total() }} entries
            </h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
                    <li><a href="{{ URL::to($custcases->previousPageUrl()) }}">Previous</a></li>
                    <li><a href="javascript:">{{ $custcases->currentPage() }}</a></li>
                    <li><a href="{{ URL::to($custcases->nextPageUrl()) }}">Next</a></li>
                </ul>
            </span>
        </div>
    </div>
...
@if ($module == 'bank')
    ...
    <div class="table-responsive">
                ...
                @if (count($banks) > 0)
                    @foreach ($banks as $bank)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a href="javascript:void(0)"
                                    onclick="editBankInfo('{{ $bank->id }}');">{{ $bank->bank_name }}</a></td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $banks->firstItem() == '' ? '0' : $banks->firstItem() }} to
                {{ $banks->lastItem() == '' ? '0' : $banks->lastItem() }} of {{ $banks->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'contra')
    ...
    <div class="table-responsive">
            ...
            <tbody id="customertable">
                @if (count($contras) > 0)
                    @foreach ($contras as $contra)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a href="{{ route('contra-entry-edit', $contra->id) }}">{{ $contra->contra_no }}</a>
                            </td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $contras->firstItem() == '' ? '0' : $contras->firstItem() }} to
                {{ $contras->lastItem() == '' ? '0' : $contras->lastItem() }} of {{ $contras->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'suppaybatch')
    ...
    <div class="table-responsive">
                ...
                @if (count($suppaybatches) > 0)
                    @foreach ($suppaybatches as $suppaybatch)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a
                                    href="{{ route('supp-paybatch-edit', $suppaybatch->id) }}">{{ $suppaybatch->batch_no }}</a>
                            </td>
                            <td>{{ $suppaybatch->batch_pay_date }}</td>
                            <td>{{ $suppaybatch->supplier_name }}</td>
                            <td>{{ $emp->payable_manage[$suppaybatch->batch_invtype] }}</td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $suppaybatches->firstItem() == '' ? '0' : $suppaybatches->firstItem() }} to
                {{ $suppaybatches->lastItem() == '' ? '0' : $suppaybatches->lastItem() }} of {{ $suppaybatches->total() }}
                entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
...
@if ($module == 'sundpaybatch')
    ...
    <div class="table-responsive">
                ...
                @if (count($sundpaybatches) > 0)
                    @foreach ($sundpaybatches as $sundpaybatch)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a
                                    href="{{ route('sundry-payment-edit', $sundpaybatch->id) }}">{{ $sundpaybatch->sund_pay_no }}</a>
                            </td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $sundpaybatches->firstItem() == '' ? '0' : $sundpaybatches->firstItem() }} to
                {{ $sundpaybatches->lastItem() == '' ? '0' : $sundpaybatches->lastItem() }} of
                {{ $sundpaybatches->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'custrcptentry')
    ...
    <div class="table-responsive">
                ...
                @if (count($custrcptentries) > 0)
                    @foreach ($custrcptentries as $custrcptentry)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a
                                    href="{{ route('cust-dreceipt-entry-edit', $custrcptentry->id) }}">{{ $custrcptentry->receipt_no }}</a>
                            </td>
                            <td>{{ $custrcptentry->receipt_date }}</td>
                            <td>{{ $custrcptentry->customer_name }}</td>
                            <td>{{ $emp->receivable_manage[$custrcptentry->receipt_invtype] }}</td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $custrcptentries->firstItem() == '' ? '0' : $custrcptentries->firstItem() }}
                to {{ $custrcptentries->lastItem() == '' ? '0' : $custrcptentries->lastItem() }} of
                {{ $custrcptentries->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'sundrcptentry')
    ...
    <div class="table-responsive">
                ...
                @if (count($sundrcptentries) > 0)
                    @foreach ($sundrcptentries as $sundrcptentry)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a
                                    href="{{ route('sundry-receipt-edit', $sundrcptentry->id) }}">{{ $sundrcptentry->sundry_rcpt_no }}</a>
                            </td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $sundrcptentries->firstItem() == '' ? '0' : $sundrcptentries->firstItem() }}
                to {{ $sundrcptentries->lastItem() == '' ? '0' : $sundrcptentries->lastItem() }} of
                {{ $sundrcptentries->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'cdrtransaction')
    ...
    <div class="table-responsive">
                ...
                @if (count($cdrtransactions) > 0)
                    @foreach ($cdrtransactions as $cdrtransaction)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a
                                    href="{{ route('cdr-edit', $cdrtransaction->id) }}">{{ $cdrtransaction->trans_type }}</a>
                            </td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $cdrtransactions->firstItem() == '' ? '0' : $cdrtransactions->firstItem() }}
                to {{ $cdrtransactions->lastItem() == '' ? '0' : $cdrtransactions->lastItem() }} of
                {{ $cdrtransactions->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'lead')
    ...
    <div class="table-responsive">
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $leads->firstItem() == '' ? '0' : $leads->firstItem() }} to
                {{ $leads->lastItem() == '' ? '0' : $leads->lastItem() }} of {{ $leads->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'subscribe')
    ...
    <div class="table-responsive">
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $subscribers->firstItem() == '' ? '0' : $subscribers->firstItem() }} to
                {{ $subscribers->lastItem() == '' ? '0' : $subscribers->lastItem() }} of {{ $subscribers->total() }}
                entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
...
@if ($module == 'image')
    ...
    <div class="table-responsive">
                ...
                @if (count($images) > 0)
                    @foreach ($images as $image)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a href="javascript:void(0)"
                                    onclick="editGalleryImage('{{ $image->id }}')">{{ $image->id }}</a></td>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $images->firstItem() == '' ? '0' : $images->firstItem() }} to
                {{ $images->lastItem() == '' ? '0' : $images->lastItem() }} of {{ $images->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'job')
    ...
    <div class="table-responsive">
                ...
                @if (count($jobs) > 0)
                    @foreach ($jobs as $job)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a href="javascript:void(0)"
                                    onclick="editJob('{{ $job->id }}')">{{ $job->job_title }}</a></td>
                            <td>{{ $job->job_category }}</td>
                            <td>{{ $job->job_location }}</td>
                            <td>{{ $job->job_status }}</td>
                            <td>{{ $job->created_date }}</td>
                            <td><a href="javascript:void(0)" class="btn btn-primary btn-sm"
                                    onclick="changeJobStatus('{{ $job->id }}',this,'{{ $job->job_status }}')">Change
                                    Status</a></td>
                        </tr>
                    @endforeach
                @else
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $jobs->firstItem() == '' ? '0' : $jobs->firstItem() }} to
                {{ $jobs->lastItem() == '' ? '0' : $jobs->lastItem() }} of {{ $jobs->total() }} entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
                <ul class="pagination">
...
@if ($module == 'applicant')
    ...
    <div class="table-responsive">
                ...
                @if (count($applicants) > 0)
                    @foreach ($applicants as $applicant)
                        <tr>
                            <td>{{ ++$table_count }}</td>
                            <td><a href="javascript:void(0)"
                                    onclick="editapplicant('{{ $applicant->id }}')">{{ $applicant->job_title }}</a>
                            </td>
                            ...
                            <td><a href="javascript:void(0)" class="btn btn-primary btn-sm" data-html="true"
                    ...
                    <a href='/download/applicant/resume/{{ $applicant->applicant_resume }}'' class='btn btn-link'>Download Resume</a><br>"><i
                                        class="fa fa-cogs"></i>&nbsp;Actions</a>
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $applicants->firstItem() == '' ? '0' : $applicants->firstItem() }} to
                {{ $applicants->lastItem() == '' ? '0' : $applicants->lastItem() }} of {{ $applicants->total() }} entries
            </h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
...
@if ($module == 'workstatus')
    ...
    <div class="table-responsive">
                    ...
                    @foreach ($workstatuses as $workstatus)
                        <tr>
                            ...
                            @if ($workstatus->allow_edit == 'edit')
                                <td><a href="javascript:void(0)"
                                        onclick="editWorkStatus('{{ $workstatus->id }}')">{{ $workstatus->today_date }}</a>
                                </td>
                            @else
        ...
        <div class="col-sm-6">
            <h5 class="pagination">Showing {{ $workstatuses->firstItem() == '' ? '0' : $workstatuses->firstItem() }} to
                {{ $workstatuses->lastItem() == '' ? '0' : $workstatuses->lastItem() }} of {{ $workstatuses->total() }}
                entries</h5>
        </div>
        <div class="col-sm-6">
            <span class="pull-right">
...
@if ($module == 'approvedmerchant')
    ...
    @if (isset($approvedmerchants))
        ...
        <div class="table-responsive ">
            <table class="table table-bordered  text-nowrap">
                ...
                <tbody id="bginfotable">
                    @if (count($approvedmerchants) > 0)
                        <?php $rowc = $approvedmerchants->firstItem(); ?>
                        @foreach ($approvedmerchants as $approvedmerchant)
                            <tr>
                                <td>{{ $rowc++ }}</td>
                                <td> <a href="javascript:void(0)"
                                        onclick="verifyMerchantDetails('{{ $approvedmerchant->id }}')">{{ $approvedmerchant->merchant_gid }}</a>
                                </td>
                                ...
                                <td>{{ \Carbon\Carbon::parse($approvedmerchant->created_date)->format('M d, Y H:m:s') }}
                                </td>
                                <td>{{ $approvedmerchant->merchant_status }}</td>
                                <td>

                                    <button class="btn btn-success btn-sm"
                                        onclick="MakeMerchantLive('{{ $approvedmerchant->id }}',this)">Make
                                        Live</button>

                                    <button
                                        style="{{ $approvedmerchant->merchant_status == 'active' ? '' : 'display:none' }}"
                                        id="inactive-btn" class="btn btn-danger btn-sm merchant-inactive-btn"
                                        onclick="MakeMerchantInactive('{{ $approvedmerchant->id }}',this)"
                                        data-merchantstatus={{ $approvedmerchant->merchant_status }}>Make
                                        Inactive</button>
                                    <button
                                        style="{{ $approvedmerchant->merchant_status == 'active' ? 'display:none' : '' }}"
                                        id="active-btn" class="btn btn-primary btn-sm  merchant-active-btn"
                                        onclick="MakeMerchantInactive('{{ $approvedmerchant->id }}',this)"
                                        data-merchantstatus={{ $approvedmerchant->merchant_status }}>Make
                                        active</button>
                               ...
                               Change Password
                                    ...
                                    <a href="{{ route('merchant-details-view', $approvedmerchant->id) }}"
                                        class="edit btn btn-success btn-sm"><ion-icon
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $approvedmerchants->firstItem() == '' ? '0' : $approvedmerchants->firstItem() }} to
                    {{ $approvedmerchants->lastItem() == '' ? '0' : $approvedmerchants->lastItem() }} of
                    {{ $approvedmerchants->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    <li><a href="{{ URL::to($approvedmerchants->previousPageUrl()) }}">Previous</a></li>
                    <li><a href="javascript:">{{ $approvedmerchants->currentPage() }}</a></li>
                    <li><a href="{{ URL::to($approvedmerchants->nextPageUrl()) }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'merchantcharge')
    @if (isset($merchantcharges))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($merchantcharges) > 0)
                        @foreach ($merchantcharges as $merchantcharge)
                            <tr>
                                ...
                                <td>{{ $merchantcharge->business_name }}</td>
                                <td>{{ $merchantcharge->type_name }}</td>
                                <td>{{ \Carbon\Carbon::parse($merchantcharge->created_date)->format('d-M, Y h:i:s A') }}
                                </td>
                                <td><button class="btn btn-warning btn-sm"
                                        onclick="editMerchantCharges('{{ $merchantcharge->id }}',this)">Edit
                                        Charges</button></td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $merchantcharges->firstItem() == '' ? '0' : $merchantcharges->firstItem() }} to
                    {{ $merchantcharges->lastItem() == '' ? '0' : $merchantcharges->lastItem() }} of
                    {{ $merchantcharges->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    <li><a href="{{ url('/') }}{{ $merchantcharges->previousPageUrl() }}">Previous</a></li>
                    <li><a href="javascript:">{{ $merchantcharges->currentPage() }}</a></li>
                    <li><a href="{{ url('/') }}{{ $merchantcharges->nextPageUrl() }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'merchantcommercial')
    @if (isset($merchantcommercials))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($merchantcommercials) > 0)
                        @foreach ($merchantcommercials as $merchantcommercial)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($merchantcommercial->created_date)->format('d-m-Y H:i:s') }}</td>
                                <td><button class="btn btn-warning btn-sm"
                                        onclick="viewMerchantCommercials('{{ $merchantcommercial->id }}',this)">View
                                        Charges</button></td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $merchantcommercials->firstItem() == '' ? '0' : $merchantcommercials->firstItem() }} to
                    {{ $merchantcommercials->lastItem() == '' ? '0' : $merchantcommercials->lastItem() }} of
                    {{ $merchantcommercials->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
        ...
        <div class="table-responsive">
            <form id="settle-transactions-form" method="POST">
                <table class="table table-bordered text-nowrap">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <input type="checkbox" class="form-control"
                                            onclick="selectAllTransactionIds(this);">
                                        <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                    </label>
                                </div>
                            </th>
                    ...
                    <tbody id="bginfotable">
                        @inject('settle', 'App\SettlementBrief')
                        @if (count($alltransactions) > 0)
                            <?php $rowc = $alltransactions->firstItem(); ?>
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="id[]" id="id"
                                                    class="form-control" value="{{ $alltransaction->id }}">
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                            </label>
                                        </div>
                                    </td>
                                    <td>{{ \Carbon\Carbon::parse($alltransaction->created_date)->format('M d, Y H:i:s') }}
                                    </td>
                                    <td>{{ $alltransaction->merchant_gid }}</td>
                                    <td>{{ $alltransaction->name }}</td>
                                    <td>{{ $alltransaction->id }}</td>

                                    <td id="transactiongid"><a
                                            href="javascript:admintransactionDetailsView('{{ $alltransaction->transaction_gid }}')">{{ $alltransaction->transaction_gid }}</a>
                                    </td>
                                    <td>{{ $alltransaction->merchantorderId }}</td>

                                    <td>{{ $alltransaction->transaction_amount }}</td>

                                    <td>{{ \Carbon\Carbon::parse($alltransaction->created_date)->format('M d, Y H:i:s') }}
                                    </td>
                                    <td>{{ $alltransaction->uname }}</td>
                                    <td>{{ $alltransaction->uemail }}</td>
                                    <td>{{ $alltransaction->ucontact }}</td>


                                    <td>{{ $alltransaction->transaction_status }}</td>
                                    <td>{{ $alltransaction->transaction_mode }}</td>
                                    <td>{{ $alltransaction->transaction_adjustment_charged_per }}</td>
                                    <td>{{ $alltransaction->transaction_adjustment_charged_amount }}</td>
                                    <td>{{ $alltransaction->transaction_gst_value }}</td>
                                    <td>{{ $alltransaction->transaction_gst_charged_amount }}</td>
                                    <td>{{ $alltransaction->transaction_total_charged_amount }}</td>
                                    <td>{{ $alltransaction->transaction_total_adjustment }}</td>
                                    <td>{{ $alltransaction->bank_ref_no }}</td>
                                    <td>{{ $alltransaction->customer_vpa }}</td>
                                    <td>{{ $alltransaction->uip }}</td>
                                    @if ($alltransaction->settlement_brief_gid)
                                        <?php $settle_details = $settle->get_details($alltransaction->settlement_brief_gid); ?>
                                        <td>{!! fsettlement_status($settle_details->settlement_status, 1) !!}</td>
                                        <td>{{ $alltransaction->settlement_brief_gid }}</td>
                                    @else
                                        <td>-</td>
                                        <td>-</td>
                                    @endif
                                    <td id="transactiongid1">
                                        <button class="btn btn-sm btn-success m-2 viewreqres" style="margin-right: 10px;"  orderid={{$alltransaction->transaction_gid }}><ion-icon name="tv-outline"></ion-icon></button>
                                        @if ($alltransaction->refund_gid)
                                            {!! frefund_status($alltransaction->refund_status, 1) !!}
                                        @elseif($alltransaction->transaction_status == 'success')
                                            <a href="javascript:transactionRefund('{{ $alltransaction->id }}')"
                                                class="btn btn-danger btn-sm">{{ 'Initiate' }}</a>
                                        @else
                                            {{ '-' }}
                                        @endif
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $alltransactions->firstItem() == '' ? '0' : $alltransactions->firstItem() }} to
                    {{ $alltransactions->lastItem() == '' ? '0' : $alltransactions->lastItem() }} of
                    {{ $alltransactions->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    <li><a href="{{ url('/') }}{{ $alltransactions->previousPageUrl() }}">Previous</a></li>
                    <li><a href="javascript:">{{ $alltransactions->currentPage() }}</a></li>
                    <li><a href="{{ url('/') }}{{ $alltransactions->nextPageUrl() }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'adjustmentcharge')
    @if (isset($adjustmentcharges))
        ...
        <div class="table-responsive">
                    ...
                    @if (count($adjustmentcharges) > 0)
                        @foreach ($adjustmentcharges as $adjustmentcharge)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($adjustmentcharge->created_date)->format('d-M, Y h:i:s A') }}
                                </td>
                                <td><button class="btn btn-success btn-sm"
                                        onclick="editadjustmentCharges('{{ $adjustmentcharge->merchant_id }}',this)">Edit
                                        Charges</button></td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $adjustmentcharges->firstItem() == '' ? '0' : $adjustmentcharges->firstItem() }} to
                    {{ $adjustmentcharges->lastItem() == '' ? '0' : $adjustmentcharges->lastItem() }} of
                    {{ $adjustmentcharges->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'merchantroute')
    @if (isset($merchantroutes))
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody id="bginfotable">
                    @if (count($merchantroutes) > 0)
                        <?php $rowc = $merchantroutes->firstItem(); ?>
                        @foreach ($merchantroutes as $merchantroute)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($merchantroute->created_date)->format('d-M, Y h:i:s A') }}
                                </td>
                                <td><button class="btn btn-success btn-sm "
                                        onclick="editMerchantRoutes('{{ $merchantroute->id }}',this)">Edit
                                        Route</button></td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $merchantroutes->firstItem() == '' ? '0' : $merchantroutes->firstItem() }} to
                    {{ $merchantroutes->lastItem() == '' ? '0' : $merchantroutes->lastItem() }} of
                    {{ $merchantroutes->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    <li><a href="{{ URL::to($merchantroutes->previousPageUrl()) }}">Previous</a></li>
                    <li><a href="javascript:">{{ $merchantroutes->currentPage() }}</a></li>
                    <li><a href="{{ URL::to($merchantroutes->nextPageUrl()) }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'merchantusage')
    @if (isset($merchantusages))
        @php($table_count = 0)
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>Daily Total Limit</th>
                        <th>Created Date</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody id="bginfotable">
                    @if (count($merchantusages) > 0)
                        <?php $rowc = $merchantusages->firstItem(); ?>
                        @foreach ($merchantusages as $merchantusage)
                            <tr>
                                <td>{{ $rowc++ }}</td>
                                <td>{{ $merchantusage->merchant_gid }}</td>
                                <td>{{ $merchantusage->name }}</td>
                                <td>{{ $merchantusage->type_name }}</td>
                                <td>{{ $merchantusage->minimum_ticket_size }}</td>
                                <td>{{ $merchantusage->maximum_ticket_size }}</td>
                                <td>{{ $merchantusage->daily_total_limit }}</td>
                                <td>{{ \Carbon\Carbon::parse($merchantusage->created_date)->format('d-M, Y h:i:s A') }}
                                </td>
                                <td><button class="btn btn-success btn-sm editMerchantUsage"
                                        mid="{{ $merchantusage->id }}">Edit Usage Setting</button></td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $merchantusages->firstItem() == '' ? '0' : $merchantusages->firstItem() }} to
                    {{ $merchantusages->lastItem() == '' ? '0' : $merchantusages->lastItem() }} of
                    {{ $merchantusages->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
                    <li><a href="{{ URL::to($merchantusages->previousPageUrl()) }}">Previous</a></li>
                    <li><a href="javascript:">{{ $merchantusages->currentPage() }}</a></li>
                    <li><a href="{{ URL::to($merchantusages->nextPageUrl()) }}">Next</a></li>
                </ul>
            </div>
        </div>
    @endif
...
@if ($module == 'vendoradjustment')
    @if (isset($vendoradjustments))
        ...
        <div class="table-responsive" id="">
            <form id="managepay-adjustment-form" method="POST">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Sno</th>
                            <th>
                                <div class="checkbox">
                                    <label>
                                        <strong>Select All</strong>
                                        <input type="checkbox" class="form-control"
                                            onclick="selectAllVendorAdjustmentIds(this);">
                                        <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                    </label>
                                </div>
                            </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="id[]" id="id"
                                                    class="form-control" value="{{ $vendoradjustment->id }}">
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                            </label>
                                        </div>
                                    </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $vendoradjustments->firstItem() == '' ? '0' : $vendoradjustments->firstItem() }} to
                    {{ $vendoradjustments->lastItem() == '' ? '0' : $vendoradjustments->lastItem() }} of
                    {{ $vendoradjustments->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'ryapayadjustment')
    @if (isset($ryapayadjustments))
        ...
        <div class="table-responsive" id="">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $ryapayadjustments->firstItem() == '' ? '0' : $ryapayadjustments->firstItem() }} to
                    {{ $ryapayadjustments->lastItem() == '' ? '0' : $ryapayadjustments->lastItem() }} of
                    {{ $ryapayadjustments->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'extdoc')
    @if (isset($extdocs))
        ...
        <div class="table-responsive" id="">
                        ...
                        @if (count($extdocs) > 0)
                            @foreach ($extdocs as $extdoc)
                                <tr>
                                    <td>{{ ++$table_count }}</td>
                                    <td><a
                                            href="{{ route('extra-document', base64_encode($extdoc->id)) }}">{{ $extdoc->name }}</a>
                                    </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing {{ $extdocs->firstItem() == '' ? '0' : $extdocs->firstItem() }} to
                    {{ $extdocs->lastItem() == '' ? '0' : $extdocs->lastItem() }} of {{ $extdocs->total() }} entries
                </h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'cashfreeroute')
    @if (isset($cashfreeroutes))
        ...
        <div class="table-responsive" id="">
                    ...
                    @if (count($cashfreeroutes) > 0)
                        @foreach ($cashfreeroutes as $cashfreeroute)
                            <tr>
                                <td>{{ ++$table_count }}</td>
                                <td><a href="javascript:void(0)"
                                        onclick="editCashFreeKey('{{ $cashfreeroute->id }}')">{{ $cashfreeroute->business_name }}</a>
                                </td>
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $cashfreeroutes->firstItem() == '' ? '0' : $cashfreeroutes->firstItem() }} to
                    {{ $cashfreeroutes->lastItem() == '' ? '0' : $cashfreeroutes->lastItem() }} of
                    {{ $cashfreeroutes->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
...
@if ($module == 'campaignlist')
    @if (isset($campaignlists))
        ...
        <div class="table-responsive" id="">
            ...
            <div class="col-sm-6">
                <h5 class="pagination">Showing
                    {{ $campaignlists->firstItem() == '' ? '0' : $campaignlists->firstItem() }} to
                    {{ $campaignlists->lastItem() == '' ? '0' : $campaignlists->lastItem() }} of
                    {{ $campaignlists->total() }} entries</h5>
            </div>
            <div class="col-sm-6 text-right">
                <ul class="pagination">
