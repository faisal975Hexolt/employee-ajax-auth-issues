...
<div id="invoiceholder">
  ...
  <div id="invoice" class="effect2">
    ...
    <div id="invoice-bot">
      ...
      <div id="legalcopy">
        <p class="legal"><strong>Want to create invoice for your Business!</strong> Visit <span style="color: #178dbb;">s2payments.in/invoice</span> and get started instantly. 
        </p>
      </div>
              ...
              <div class="row">
                  <div class="course-expiry">
                      <div class="container course-payink-expiry">
                          ...
                          <div class="row">
                              <div class="card-footer">
                                  <p>Powered by <span class="power"><a href="/">{{env('APP_NAME')}}.in</a></span></p> 
                              </div>
                          </div>
                      </div>
                  </div>
