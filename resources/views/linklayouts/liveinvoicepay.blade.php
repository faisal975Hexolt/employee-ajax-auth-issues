  ...
  <div id="invoice" class="effect2">
    <div id="invoice-top">
      <div class="logo">
          ...
          @else
            <img src="{{ asset('new/img/s2Pay_Logo_white.png')}}" class="img-responsive" alt="{{env('APP_NAME')}}" width="70px" height="60px">
          @endif 
    ...
    <div id="invoice-bot">
      ...
      <div id="legalcopy">
        <p class="legal"><strong>Want to create invoice for your Business!</strong> Visit <span style="color: #178dbb;"><a href="{{url('/')}}" target="_blank">{{env('APP_NAME')}}</a> </span> and get started instantly. 
        </p>
      </div>
                      ...
                      <div class="container course-payink-expiry">
                          <div class="row">
                              <div class="card-header">
                                  ...
                                  <h4 class="card-header-message">Thank you for using our {{env('APP_NAME')}} Service</h4>
                              </div>
                          </div>
                          <div class="row">
                              <div class="card-body">
                          ...
                          <div class="row">
                              <div class="card-footer">
                                  <p>Powered by <span class="power"><a href="{{'WEBSITE'}}">{{env('APP_NAME_FULL')}}</a></span></p> 
                              </div>
                          </div>
                      </div>
                  </div>
