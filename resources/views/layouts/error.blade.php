        ...
        <footer id="footer">
            ...
            <div class="container">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <h3>{{env('APP_NAME_FULL')}}</h3>
                    <p class="pb-3"><em>If your business needs assistance in digital payments, then we are a force to be reckon with. With {{env('APP_NAME')}} payment gateway, you can instantly setup a business account, automate payments, and acquire collateral-free capital loans with ease. Capitalizing on our state-of-the-art technology, you can offer your customers a simplified and secure online payment experience with multiple options. Our experts will ensure a smooth running of your payment ecosystem. We take care of your digital payments, you can invest your energies in growing your business.</em></p>
                    <p>
                      <div>{{env('APP_NAME')}}</div>
                      <div>{{env('COMPANY_ADDRESS')}}</div>
                      
                      <br><br>
                      <strong>Phone:</strong>{{ env('SUPPORT_NUMBER') }}<br>
                      <strong>Email:</strong> {{ env('COMPANY_CONTATCT') }}<br>
                    </p>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <li><i class="bx bx-chevron-right"></i> <a href="/rpay-doc">Spay Docs</a></li>
            ...
            <div class="mr-md-auto text-center text-md-left">
                <div class="credits">
                  &copy;{{date('Y')}}&nbsp;Copyright <strong><span>{{env('APP_NAME')}}</span></strong>. All Rights Reserved
                Designed by <a href="#">{{env('APP_NAME')}}</a>
                </div>
            </div>
            <div class="social-links text-center text-md-right pt-3 pt-md-0">
                <a href="https://twitter.com/{{env('APP_NAME')}}" class="twitter"><i class="bx bxl-twitter"></i></a>
                <a href="https://www.facebook.com/{{env('APP_NAME')}}.India/" class="facebook"><i class="bx bxl-facebook"></i></a> 
                <a href="https://www.instagram.com/{{env('APP_NAME')}}/" class="instagram"><i class="bx bxl-instagram"></i></a>
                <a href="#" class="google-plus"><i class="bx bxl-skype"></i></a>
                <a href="https://www.linkedin.com/company/{{env('APP_NAME')}}/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
            </div>
            </div>
        </footer>
</div>
