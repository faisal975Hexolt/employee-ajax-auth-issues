            ...
            <div class="auth-form-container auth-signup-form-container">
                ...
                <form method="POST" autocomplete="off" id="merchant-register">
                    ...
                    <div class="auth-form-group name-control">
                        <input type="text" class="auth-form-control" name="name" id="name" placeholder="Name"
                            value="{{ old('name') }}" onkeyup="validateName('name');">
                    </div>
                    <div class="auth-form-group email-control">
                        <input type="text" class="auth-form-control" name="email" placeholder="Email"
                            autocapitalize="off" autocomplete="off" value="{{ old('email') }}">
                    </div>
                    <div class="auth-form-group mobile-control">
                        <input type="text" class="auth-form-control" name="mobile_no" placeholder="Mobile"
                            value="{{ old('mobile_no') }}" onkeypress="return isNumber(event)">
                    </div>
                    <div class="auth-form-group password-control">
                        <input type="password" class="auth-form-control" name="password" placeholder="Password">
                    </div>
                    <div class="auth-form-group password-control">
                        <input type="password" class="auth-form-control" name="password_confirmation"
                    ...
                    <div class="flex-container">
                        <div class="checkbox">
                            <label>
                                ...
                                By clicking the checkbox, you agree to the <a href="{{ env('TERM_CONDITION_URL') }}">Terms
                                    & Conditions</a></a>
                    ...
                    <p class="sign-up-txt">Already have an account? <a href="{{ route('login') }}">Sign In</a></p>
                </form>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12 text-center pb-5">
                                <img src="assets/img/registration.jpg" width="280" height="130" alt="avatar"
                            ...
                            <div class="col-sm-12">
                                <form id="mobile-verification">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="otp_number" maxlength="10" type="text" class="form-control"
                                                name="otp_number" value="{{ old('otp_number') }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <a href="javascript:" class="btn-link float-right"
                                                id="resend-mobile-sms">Send OTP Again</a>
                                        </div>
                                    </div>
                                    {{ csrf_field() }}
                                    <div class="form-group row">
                                        <div class="col-sm-8 offset-sm-4">
                                            <input type="submit" id="OTPSubmit" class="btn btn-primary" value="Next">
                                        </div>
                                    </div>
                                </form>
                            </div>
