...
<section id="about-1" class="about-1">
    ...
    <div class="col-lg-6" data-aos="zoom-in">
        <img src="{{ asset('assets/img/merchant-invoice.png') }}" width="370" height="250" class="img-fluid" id="img-dash" alt="merchant-invoice.png">
    </div>
    </div>
                    ...
                    <div class="tab-content">
                        <div id="invoices" class="tab-pane fade in active">
                            <div class="tab-button">
                                <a href="{{route('show-invoice')}}"  class="btn btn-primary btn-md">Add Invoice</a>
                            </div>
                            <div class="row Topmarg">
                                <div class="col-sm-7">
                                    <div class="col-sm-2">
                                        <select name="page_limit" class="form-control marg" onchange="getAllInvoices($(this).val())">
                        ...
                        <div id="items" class="tab-pane">
                            <div class="tab-button">
                                <div id="additemmodal" class="btn btn-primary btn-md">Add Item</div> 
                            </div>
                            <div class="row Topmarg">
                                <div class="col-sm-7">
                                    <div class="col-sm-2">
                                        <select name="page_limit" class="form-control marg" onchange="getAllItems($(this).val())">
                                            @foreach($per_page as $index => $page)
                                            <option value="{{$index}}">{{$page}}</option>
                                        @endforeach
                                        </select>
                                                ...
                                                <div id="add-multi-items" class="tab-pane fade in active">
                                                    ...
                                                    <form class="form-inline" id="itemadd">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <div id="new-item" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Items</div>
                                                            <input type="submit" class="btn btn-success pull-right btn-sm" value="Submit">
                                                        </div>
                                                    </form>
                                                    </div>
                                                </div>
                                                           ...
                                                           <tr>
                                                                    <td><label for="email">Items File Upload</label></td>
                                                                     <td>
                                                                        ...
                                                                        <h6>Only xls,xlsx files can upload</h6>
                                                                    ...
                                                                    <!-- <td><class="text-left">Only xls,xlsx files can upload</caption></td> -->
                                                                </tr>
                                                                <tr>
                                                                    <td> </td>
                                                                    <td><input type="submit" class="btn btn-primary" value="Upload"> <input type="reset" id="reset-bulk-items-form" class="btn btn-danger" value="Reset"></td>
                        ...
                        <div id="customers" class="tab-pane">
                            <div class="tab-button">
                                <div id="add-customer-call" class="btn btn-primary btn-md">Add Customer</div>    
                            </div>
                            <div class="row Topmarg">
                                <div class="col-sm-7">
                                    <div class="col-sm-2">
                                        <select name="page_limit" class="form-control marg" onchange="getAllCustomers($(this).val())">
                                            @foreach($per_page as $index => $page)
                                            <option value="{{$index}}">{{$page}}</option>
                                        @endforeach
                                        </select>
