...
<div class="col-sm-6">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="mode" id="listmode">
            ...
            <option {{ request()->input('mode') == $r ? "selected" :""}} value="{{$r}}">{{ucwords($mode)}}</option>
            @endforeach
...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <select class="form-control" name="status" id="">
            ...
            <option {{ request()->input('status') == $status ? "selected" :""}} value="{{$status}}">{{ucwords($status)}}
            </option>
            @endforeach
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <select class="form-control" name="status" id="">
            ...
            <option {{ request()->input('status') == $status ? "selected" :""}} value="{{$status}}">{{frefund_status($status)}}
            </option>
            @endforeach
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <select class="form-control" name="status" id="">
            ...
            <option {{ request()->input('status') == $status ? "selected" :""}} value="{{$status}}">{{fsettlement_status($status)}}
            </option>
            @endforeach
