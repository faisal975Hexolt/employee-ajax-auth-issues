@php
    ...
    $fromDate = \Carbon\Carbon::now()->format('Y-m-d 00:00:00');
    $toDate = \Carbon\Carbon::now()->format('Y-m-d 23:59:59');
...
@section('merchantcontent')
            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-flex flex-column justify-contents-center" data-aos="fade-left">
                    <div class="content-1 pt-4 pt-lg-0">
                        ...
                        <h3 class="MargH3">Welcome to {{ env('WEB_NAME') }} Dashboard </h3>
                        ...
                        @if (App\Classes\MerchantValidate::documentStatus())
                            <div class="col-sm-12 padding-20">
                                <div class="panel panel-default">

                                    <div class="panel-body">

                                        We Need More clarification for cerification purpose : <a
                                            href="{{ route('reonboarding') }}" class="btn btn-primary ">Procced button</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if (App\Classes\MerchantValidate::documentEsignStatus())
                            <div class="col-sm-12 padding-20">
                                <div class="panel panel-default">

                                    <div class="panel-body">
                                        @if (App\Classes\MerchantValidate::iSdocumentEsignRejected())
                                            Your Agreement is Ready , Esign to Agreement is Pednding. In Privious Try its
                                            get rejected .Please use Aadhar number of {{ Auth::user()->business->mer_name }}
                                        @else
                                            Your Agreement is Ready , Please Initiate to Esign Agreement document :
                                        @endif


                                        <a href="{{ route('initite_esign_agreement') }}" class="btn btn-primary ">Procced
                                            button</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-12 " style="display:{{ Auth::user()->app_mode ? 'block' : 'none' }}">
                    <div class="panel panel-default">
                                ...
                                <div id="dash-graphs-summary">
                                    <div class="src">
                                        <form id="dashboard-form-summary">
                                            <input class="" id="dash_date_range_summary"
                                                name="dash_date_range_summary" placeholder="MM/DD/YYYY" type="text"
                                                value="">


                                            <input type="hidden" name="dash_from_date" value="{{ $fromDate }}">
                                            <input type="hidden" name="dash_to_date" value="{{ $toDate }}">
    ...
    <div class="row" style="display:{{ Auth::user()->app_mode ? 'block' : 'none' }}">
        <div class="col-sm-12 padding-20">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a data-toggle="tab" class="show-cursor" data-target="#dash_logactivities">Login
                                Activities</a></li>
                    </ul>
                        ...
                        <div id="dash-graphs" class="tab-pane fade ">
                            <div class="src">
                                <form id="dashboard-form">
                                    <input class="form-control" id="dash_date_range" name="dash_date_range"
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-sm-offset-1 pie-graph">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <select name="dashboar_graph" id="dashboar_graph" class="form-control"
                                                onchange="loadPieChart($(this).val());">
                                ...
                                <div class="col-sm-6">
                                    <div class="col-sm-4">
                                        <select name="page_limit" class="form-control"
                                            onchange="setDashboardPageLimit($(this).val())">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="display-block">
                                        <strong>Note:Through online we save three months of login details Through Offline we
                                            save 1 Year of login details</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
