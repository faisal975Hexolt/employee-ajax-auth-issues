...
<!-- <div id="buton-1">
    ...
    <button class="btn btn-dark" id="Show">Showbbbbbbbbbbbbbbbbbbbbbb</button>
...
<div class="tab-content">
    ...
    <div id="add-paylink" class="tab-pane fade in active">
        ...
        <div class="" style="float:right;">
            ...
            <button type="button" class="btn btn-primary btn-md generateKeys" id="generate">
                @if(count($apikeys)==0)
                 Generate
                @else
                    Regenerate Api
        ...
        <div class="row panelH" style="margin-left:15px;">

            <div class="col-11">

                <table class="table table-striped" id="keytable" style="width:100%;margin-top:4%">
    ...
    <div id="add-bulk-paylink" class="tab-pane fade in">
        ...
        <div class="" style="margin-bottom:10px; float:right;">
            ...
            <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#ipModal">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('delete_ip_address',$ip->id)}}"><button class="btn btn-warning">Delete</button></a></td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" style="top: 145px;" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog  modal-dialog-centered " style="width:450px;" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body1" style="margin: 20px 25px 30px 25px;">
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" aria-label="Close"  class="btn btn-secondary" data-coreui-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('save_ip_whitelist')}}" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    $(function() {
           ...
           apicount='{{$apicount}}';
            $(document).on("click",".generateKeys",function() {
            ...
            if(apicount>0) {
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: "It will permanently inactive , Privious Api keys !",
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
                        confirmButtonText: 'Yes, Create New keys!'
                    }).then(function(isconfimed) {
                        console.log(isconfimed.isConfirmed);
                        if(isconfimed.isConfirmed){
                            Swal.fire(
                                'Regenerating Payout Api keys!',
    ...
    function createNewKeys(){
        ...
        $.ajax({
            ...
            url: '{{url("/")}}/merchant/generate_payout_apikeys',

            success: function(data) {

                $("#generate").html('Regenerate Api');
    ...
    function getapikeys() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                durl = '{{url("/merchant/delete_api_key")}}';
                ...
                if (len > 0) {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        var tr_str = "<tr>" +
                            ...
                            "<td align='center'>" + "<a href='" + rurl + "'" + "><button class='btn btn-warning hide'>Delete</button></a>" +
                            ...
                            `<td><button class='btn btn-danger ml-1 ViewKeys' data-cid="${clientId}" data-sid="${secretKey}" data-hid="${hashKey}" data="Client Id : ${clientId} , Secret Key : ${secretKey} , Hash Key : ${hashKey}">View</button>` + "</td>" +
...
<script>
    ...
    $(function() {
        ...
        $('#clientIdCopy').click(function() {
            ...
            Swal.fire("CleintId Copied to Clipboard", {
...
<script>
    ...
    $(function() {
        ...
        $('#secretkeyCopy').click(function() {
            ...
            Swal.fire("Secret Key Copied to Clipboard", {
...
<script>
    ...
    $(function() {
        ...
        $(document).on('click', ".ViewKeys", function() {

            var clientId = $(this).data('cid');

            var secretKey = $(this).data('sid');

            var hashKey = $(this).data('hid');
