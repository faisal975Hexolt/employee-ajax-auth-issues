...
@if ($form == 'company')
    ...
    <div class="form-group">
        <label for="business_expenditure" class="col-md-4 control-label">Montly Expenditure:<span
            ...
            <select name="business_expenditure" id="business_expenditure" class="col-sm-12 form-control">
                ...
                @foreach ($business_expenditure as $expenditure)
                    @if ($business->business_expenditure == $expenditure->id)
                        <option value="{{ $expenditure->id }}" selected="selected">{{ $expenditure->option_value }}
                        </option>
                    @else
...
@elseif($form == 'business-info')
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <select name="business_type_id" id="business_type_id" class="col-sm-12 form-control"
                onchange="setbusinessdetails(this);">
                <option value="">--Select--</option>
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="email">Business Category:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <select name="business_category_id" id="business_category_id" class="col-sm-12 form-control"
                onchange="getsubcategory(this)">
                <option value="">--Select--</option>
                @foreach ($bcategory as $bcategory)
                    @if ($business->business_category_id == $bcategory->id)
                        <option value="{{ $bcategory->id }}" selected="selected">{{ $bcategory->category_name }}
                        </option>
                    @else
    ...
    <div id="sub-category-div" class="form-group"
        style="{{ $business->business_category_id != 18 ? '' : 'display:none' }}">
        <label class="control-label col-sm-4" for="email">Business Sub Category:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <select name="business_sub_category_id" id="business_sub_category_id" class="col-sm-12 form-control"
                {{ $business->business_category_id != 18 ? '' : 'disabled' }}>
                <option value="">--Select--</option>
                @if ($business->business_category_id)
    ...
    <div id="sub-categort-others" class="form-group"
        style='{{ $business->business_category_id == 18 ? '' : 'display:none' }}'>
        <label for="input" class="col-sm-4 control-label">Business Sub Category:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <input type="text" name="business_sub_category" id="business_sub_category" class="form-control"
                value="{{ $business->business_sub_category }}"
                {{ $business->business_category_id == 18 ? '' : 'disabled' }}>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4 radio">
            <label>
                <input type="radio" name="webapp_exist" class="form-control" id="website"
                    value="{{ $business->webapp_exist == 'Y' ? 'Y' : 'N' }}"
                    {{ $business->webapp_exist == 'Y' ? 'checked' : '' }}>
        ...
        <div class="col-sm-4 radio">
            <label>
                <input type="radio" name="webapp_exist" class="form-control" id="nowebsite"
                    value="{{ $business->webapp_exist == 'N' ? 'N' : 'Y' }}"
                    {{ $business->webapp_exist == 'N' ? 'checked' : '' }}>
                <span class="cr"><i class="cr-icon fa fa-circle"></i></span>
    ...
    <div id="web-url" style="{{ $business->webapp_exist == 'Y' ? '' : 'display:none' }}">
        <div class="form-group">
            <div class="col-sm-4 col-sm-offset-4">
                <input type="text" class="form-control" id="webapp_url" name="webapp_url"
                    aria-describedby="basic-addon1" value="{{ $business->webapp_url }}"
                    {{ $business->webapp_exist == 'Y' ? '' : 'disabled' }} />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="bank_name" name="bank_name"
                value="{{ $business->bank_name }}" placeholder="Bank Name" onkeyup="validateName('bank_name')">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="bank_acc_no" name="bank_acc_no"
                value="{{ $business->bank_acc_no }}" placeholder="Bank Ac no"
                onkeyup="acceptOnlyNumeric('bank_acc_no','bank_acc_no_error')">
            <div id="bank_acc_no_error"></div>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="pan-number">Bank IFSC Code:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <input type="text" class="form-control validatebank_ifsc_code" id="bank_ifsc_code"
                name="bank_ifsc_code" value="{{ $business->bank_ifsc_code }}" placeholder="Bank IFSC">
            <div id="bank_ifsc_code_error"></div>
        </div>
    </div>
    <div class="form-group" id="ifsc_details">
...
@elseif($form == 'business-card')
    ...
    <div class="form-group"> Note<span class="mandatory">*</span>: <u>Authorized Signatory should be director of the
            company</u> </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="pan-number">Company PAN No:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <input type="text" class="form-control" id="comp_pan_number" name="comp_pan_number"
                value="{{ $business->comp_pan_number }}" placeholder="Company Pan"
                onkeyup="ValidateCompanyPAN('comp_pan_number','comp_pan_number_error');">
            <div id="comp_pan_number_error"></div>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="pan-number">Corporate Identification Number(CIN):<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <input type="text" class="form-control" id="comp_cin" name="comp_cin"
                value="{{ $business->comp_cin }}" placeholder="Company CIN"
                onkeyup="ValidateCompanyCIN('comp_cin','comp_cin_error');">
            <div id="comp_cin_error"></div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control not-mandatory" id="comp_gst" name="comp_gst"
                value="{{ $business->comp_gst }}" placeholder="Company GST"
                onkeyup="ActivevalidateGSTno('comp_gst','comp_gst_error');">
            <div id="comp_gst_error"></div>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="pan-number">Authorized Signatory PAN No:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <input type="text" class="form-control" id="mer_pan_number" name="mer_pan_number"
                value="{{ $business->mer_pan_number }}" placeholder="Authorized Signatory PAN No"
                onkeyup="ValidatePAN('mer_pan_number','mer_pan_number_error');">
            <div id="mer_pan_number_error"></div>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="pan-number">Authorized Signatory Aadhar No:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <input type="text" @if ($business->mer_aadhar_number_verified == 'Y') readonly @endif class="form-control"
                id="mer_aadhar_number" name="mer_aadhar_number" value="{{ $business->mer_aadhar_number }}"
                placeholder="Authorized Signatory Aadhar No"
                onkeyup="validateAadharCard('mer_aadhar_number','mer_aadhar_number_error')">
            <div id="mer_aadhar_number_error"></div>

        </div>

        @if ($business->mer_aadhar_number_verified == 'N')
            <div class="col-sm-2">
                <button type="button" class="btn btn-success" id="send_aadhar_otp">
                    Send OTP
                </button>
            </div>
        @endif
    ...
    @if ($business->mer_aadhar_number_verified == 'N')
        <div class="form-group hide" id="mer_aadhar_verify_error_view">
            <label class="control-label col-sm-4" for="pan-number"></label>
            <div class="col-sm-8">
    ...
    @if ($business->mer_aadhar_number_verified == 'N')
        <div class="form-group  hide" id="otp_aadhar_view">
            <label class="control-label col-sm-4" for="pan-number">OTP for Aadhaar:<span
                    class="mandatory">*</span></label>
            <div class="col-sm-4">
                <input type="text" class="form-control not-mandatory" id="otp_aadhar_number"
                    name="otp_aadhar_number" value="" placeholder="6 Digit OTP for Aadhaar." maxlength="6"
                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                    onkeyup="validateOtpAadharCard('otp_aadhar_number','otp_aadhar_number_error')">
                <div id="otp_aadhar_number_error"></div>
            </div>
            <div class="col-sm-2">
                <button type="button" class="btn btn-success" id="verify_aadhar_otp">
                    Verify OTP
                </button>
            </div>
        </div>

        <div class="form-group hide" id="mer_aadhar_check_error_view">
            <label class="control-label col-sm-4" for="pan-number"></label>
            <div class="col-sm-8">
    ...
    @endif
    <div class="form-group">
        <label class="control-label col-sm-4" for="pan-number">Authorized Signatory Name:<span
                class="mandatory">*</span></label>
        <div class="col-sm-4">
            <input type="text" @if ($business->mer_aadhar_number_verified == 'Y') readonly @endif class="form-control"
                id="mer_name" name="mer_name" value="{{ $business->mer_name }}"
