    ...
    <div class="container-1">
      ...
      <div class="row">
        ...
        <div class="col-lg-6" data-aos="zoom-in">
          <img src="{{ asset('assets/img/merchant-utilities.png') }}" width="350" class="img-fluid" id="img-dash" alt="merchant-utilities.png">
        </div>
      </div>
                    ...
                    <div class="tab-content">
                        <div id="coupons-discounts" class="tab-pane fade in active">
                            ...
                            <div class="row Topmarg">
                                <div class="col-sm-7">
                                    <div class="col-sm-2">
                                        <select name="page_limit" class="form-control marg" onchange="getAllCoupons($(this).val())">
                        ...
                        <div id="products" class="tab-pane fade">
                            ...
                            <div class="row Topmarg">
                                <div class="col-sm-7">
                                    <div class="col-sm-2">
                                        <select name="page_limit" class="form-control marg" onchange="getAllProducts($(this).val())">
                                            @foreach($per_page as $index => $page)
                                            <option value="{{$index}}">{{$page}}</option>
                                        @endforeach
                                        </select>
