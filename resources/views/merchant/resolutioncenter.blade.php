    ...
    <div class="container-1">
      ...
      <div class="row">
        ...
        <div class="col-lg-6" data-aos="zoom-in">
          <img src="{{ asset('assets/img/merchant-conclusion.png') }}" width="350" height="250" class="img-fluid" id="img-dash" alt="merchant-conclusion.png">
        </div>
      </div>
...
<section id="about-1" class="about-1">
    <div class="container-1">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-contents-center" data-aos="fade-left">
            <div class="content-1 pt-4 pt-lg-0">
                <h3 class="margH">Resolution Center </h3>
                ...
                <div class="tab-content">
                    <div id="resolution-center" class="tab-pane fade in active">
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="col-sm-2">
                                    <select name="page_limit" class="form-control marg" onchange="getCustomerCaseData($(this).val())">
