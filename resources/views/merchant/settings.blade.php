...
<section id="about-1" class="about-1">
    ...
    <div class="row">
        ...
        <img src="{{ asset('assets/img/hero-banner.png') }}" width="350" class="img-fluid" id="img-dash" alt="merchant-settings.png">
        </div>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <ul class="nav nav-tabs" id="transaction-tabs">
                     ...
                     @if(App\Classes\MerchantValidate::validateWebhook())
                        <li><a data-toggle="tab" class="show-cursor" data-target="#web-hooks">Webhooks</a></li>
                     @endif
                      @if(App\Classes\MerchantValidate::validateApiKey())
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                        <div class="col-sm-2">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <label for="file-1" class="custom-file-upload">
                                                                    ...
                                                                    <span>
                                                                @if(!empty($merchantbusiness->business_logo))
                                                                <button class="btn btn-primary btn-xs" data-name="business_logo" onclick="removeMerchantLogo('{{$merchantbusiness->id}}','{{basename($merchantbusiness->business_logo)}}')"> 
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div>
                                                                @if(!empty($merchantbusiness->business_logo))
                                                                <a href="/download/merchant-logo/{{basename($merchantbusiness->business_logo)}}" class="btn btn-primary btn-md"><i class="fa fa-download"></i> Download</a>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group"> 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3 padtop">
                                                             <label for="input-id" class="col-sm-12"> {{($merchantbusiness->webapp_exist == 'Y')?$merchantbusiness->webapp_url:'We dont have website'}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <form class="form-horizontal" id="remainder-form">
                                        <div class="form-group">
                                            <label for="plwed" class="control-label col-sm-4">Enabled Reminders </label>
                                            <div class="col-sm-3">
