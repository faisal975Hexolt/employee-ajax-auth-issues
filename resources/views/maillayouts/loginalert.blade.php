                ...
                <tr>
                  ...
                  <td style="background-color:#efefeb;text-align:center;width:75px">
                    <div style="position: relative;">
                      <img style="vertical-align:bottom;width:100px;min-height:38px;margin-top: 8px;" src="{{asset('new/img/S2PAY_Logo.png')}}">
                    </div>
                  </td>
                ...
                <table style="margin:auto">
                  <tbody>
                    <tr>
                      <td style="">
                       <h4>{{$htmldata["otp"]}}</h4>
                      <p class="para" style="font-size: 17px;color: rgb(212, 211, 211);position: relative;bottom: 12px;">We're here to help you. Visit <span style="text-decoration: underline;"><a href="<?=env("WEBSITE")?>"><?=env("APP_NAME")?>/support</a></span> <br> for more info or <span style="text-decoration: underline;"><a href="<?=env("WEBSITE")?>">contact-us</a></span></p>
                     </td>
                    </tr>
                  </tbody>
                </table>
