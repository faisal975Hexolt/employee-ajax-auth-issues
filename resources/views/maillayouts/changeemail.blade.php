                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="emailwrapto100pc">
                                                <tr>
                                                  <td class="emailcolsplit" valign="top" width="100%">
                                                      <p style="color:#222222; font-family:Arial, Helvetica, sans-serif; font-size:17px; line-height:23px; margin-top:0; margin-bottom:20px; padding:0; font-weight:normal;">
                                                         We're here to help if you need it. Email us <span style="color: #178ddb;text-decoration: underline;font-weight: 550;"><a href="mailto:{{ env('SUPPORT_CONTATCT')}}">{{ env('SUPPORT_CONTATCT')}}</a></span> for more info or <span style="color: #178ddb;text-decoration: underline;font-weight: 550;"><a href="mailto:{{ env('COMPANY_CONTATCT')}}">{{ env('COMPANY_CONTATCT')}}</a> </span></p>
                                                ...
                                                <tr>
                                                  ...
                                                  <td class="emailcolsplit" align="left" valign="top" width="100%" style="background-color: #061f5f; padding: 30px;">
                                                      ...
                                                      <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                       ...
                                                       <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                          Please do not reply to this email, as we are unable to respond from this email address. If you need help or would like to contact us, please visit our Help Center at <a href="mailto:{{ env('SUPPORT_CONTATCT')}}">{{ env('SUPPORT_CONTATCT')}}</a><span style="text-decoration: underline;font-weight: 550;letter-spacing: 1px;">{{ env('SUPPORT_CONTATCT')}}</span></a>
                                                       </p>
                                                       <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                          This message was mailed to [{{$htmldata["email"]}}] by {{ env('APP_NAME')}}
                                                       </p>
                                                       <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                          Use the {{ env('APP_NAME')}} Service and website is subjected to our <a href="{{secure_url('/term')}}"><span style="text-decoration: underline;font-weight: 550;letter-spacing: 1px;">Term&Condition</span></a> and <a href="{{secur_url('/privacy')}}"><span style="text-decoration: underline;font-weight: 550;letter-spacing: 1px;">Privacy Policy</span></a>
                                                       </p>
                                                       <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                        {{ env('COMPANY_ADDRESS')}}
                                                       </p>
