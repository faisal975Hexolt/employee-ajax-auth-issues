          ...
          <div style="margin:0 auto;width:100%;max-width:598px;text-align:center;background-color:#061f5f">
            ...
            <div style="font-size:0;background-color:#061f5f;height: auto;">
              ...
              <div style="display:inline-block;width:70%;vertical-align:top;color:#f7f7f7;text-align:center">
                ...
                <div style="font-size:18px;font-weight:550;padding-top:12px;padding-bottom:6px;color: rgb(212, 211, 211);">Hi {{$htmldata['name']}},Your password has been successfully updated</div>
            ...
            <div style="font-size: 13px;position: relative;right: 20px;top: 40px;font-family: 'Open Sans', sans-serif;">
             <p style="float: right;">You can reach out to us <span style="color: #178ddb;text-decoration: underline;cursor: pointer;">here</span> for any other query OR <br>Contact us @ {{env("SUPPORT_CONTACT")}}/{{env("SUPPORT_MAIL")}}</p>
          </div>
