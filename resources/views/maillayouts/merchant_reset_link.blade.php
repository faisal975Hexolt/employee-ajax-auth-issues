          ...
          <div style="margin:0 auto;width:100%;max-width:598px;text-align:center;background-color:#061f5f">
                ...
                <tr>
                  ...
                  <td style="background-color:#efefeb;text-align:center;width:75px">
                    <div style=" background: #cceefa;width: 100px;height: 100px;border-radius: 50%;position: relative;top: 50px;">
                      <img style="vertical-align:bottom;width:100px;min-height:38px;margin-top: 8px;" src="{{ asset('new/img/s2Pay_Logo_email.png')}}">
                    </div>
                  </td>
            ...
            <div style="font-size:0;background-color:#061f5f;height: auto;">
              ...
              <div style="display:inline-block;width:70%;vertical-align:top;color:#f7f7f7;text-align:center">
                ...
                <div style="font-size:18px;font-weight:550;padding-top:12px;padding-bottom:6px;color: rgb(212, 211, 211);">Hi {{$htmldata['name']}}, <br> You have received this mail as you requested to reset your password <br> You can reset password by clicking Below Link:</div>
                ...
                <table style="margin:auto">
                  <tbody>
                    <tr>
                      ...
                      <h4><a href="{{ route('reset.password.get', $htmldata['token']) }}">Reset Password Link</a></h4>
                     </td>
                    </tr>
            ...
            <div style="font-size: 13px;position: relative;right: 20px;top: 40px;font-family: 'Open Sans', sans-serif;">
             <p style="float: right;">You can reach out to us <span style="color: #178ddb;text-decoration: underline;cursor: pointer;">here</span> for any other query OR Contact us @ {{env("SUPPORT_CONTACT")}}/{{env("SUPPORT_MAIL")}}</p>
          </div>
