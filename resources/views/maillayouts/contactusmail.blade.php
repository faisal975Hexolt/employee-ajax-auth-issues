                    ...
                    <tr>
                        <td width="100%">
                            <table bgcolor="#FFFFFF" border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td width="100%" bgcolor="#ffffff" style="text-align:center;"><a href="#"><img src="{{ asset('new/img/s2Pay_Logo_email.png')}}" alt="{{ env('APP_NAME')}}" style="display:inline-block; width:30% !important; height:auto !important;border-bottom-right-radius:8px;border-bottom-left-radius:8px;margin-top: 20px;" border="0"></a>
                                    </td>
                                </tr>
                           </table>
                           <table bgcolor="#FFFFFF" border="0" cellspacing="0" cellpadding="25" width="100%">
                                <tr>
                                    <td width="100%" bgcolor="#ffffff" style="text-align:left;">
                                        ...
                                        <p style="color:#222222; font-family:Arial, Helvetica, sans-serif; font-size:17px; line-height:23px; margin-top:0; margin-bottom:20px; padding:0; font-weight:normal;">
                                            We received your email message on {{date('d/m/Y')}}.Our <strong>Customer Support </strong>will respond to your email inquiry as soon as possible.If immediate assistance is needed please contact us directly through mobile phone <a href="tel:{{ env('SUPPORT_NUMBER') }}">{{ env('SUPPORT_NUMBER') }}</a>
                                         </p>
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="emailwrapto100pc">
                                              <tr>
                                                <td class="emailcolsplit" valign="top" width="100%">
                                                    <p style="color:#222222; font-family:Arial, Helvetica, sans-serif; font-size:17px; line-height:23px; margin-top:0; margin-bottom:20px; padding:0; font-weight:normal;">
                                                       We're here to help if you need it. Visit the <span style="color: #178ddb;text-decoration: underline;font-weight: 550;"><a href="{{url('/support')}}">{{ env('APP_NAME')}}/support</a></span> for more info or <span style="color: #178ddb;text-decoration: underline;font-weight: 550;"><a href="{{url('/contact')}}">contact-us</a> </span></p>
                                              ...
                                              <tr>
                                                ...
                                                <td class="emailcolsplit" align="left" valign="top" width="100%" style="background-color: #061f5f; padding: 30px;">
                                                    ...
                                                    <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                        This account email has been sent to you as part of you are {{ env('APP_NAME')}} Merchant.
                                                     </p>
                                                     <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                        Please do not reply to this email, as we are unable to respond from this email address. If you need help or would like to contact us, please visit our Help Center at <a href="{{url('/support')}}"><span style="text-decoration: underline;font-weight: 550;letter-spacing: 1px;">{{ env('APP_NAME')}}/support</span></a>
                                                     </p>
                                                     <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                        This message was mailed to [{{$htmldata["email"]}}] by {{ env('APP_NAME')}}
                                                     </p>
                                                     <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                        Use the {{ env('APP_NAME')}} Service and website is subjected to our <a href="{{url('/term')}}"><span style="text-decoration: underline;font-weight: 550;letter-spacing: 1px;">Term&Condition</span></a> and <a href="{{url('/privacy')}}"><span style="text-decoration: underline;font-weight: 550;letter-spacing: 1px;">Privacy Policy</span></a>
                                                     </p>
                                                     <p style="color:rgb(214, 212, 212); font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:19px; margin-top:0; margin-bottom:20px; font-weight:normal;">
                                                    {{ env('COMPANY_ADDRESS')}}
                                                     </p>
