...
<head>
    ...
    <title>{{env('APP_NAME_FULL')}} Document</title>
    ...
    <body style="margin:0;padding:0">
        ...
        <div>
          <div style="margin:0 auto; width:100%;max-width:598px;text-align:center;background-color:#fff">
                ...
                <tr>
                  ...
                  <td style="background-color:#efefeb;text-align:center;width:75px">
                    <div style="width: 130px;">
                      <img style="vertical-align:bottom;width:130px;margin-top: 8px;" src="{{ asset('new/img/s2Pay_Logo_email.png')}}" alt="{{env('APP_NAME')}}">
                    </div>
                  </td>
            ...
            @endif
            <p style="text-align:center justify; width:auto;background-color:#fff;padding: 12px 20px;font-size: 15px;font-weight: 400;color: rgb(143, 143, 143);">&copy; Copyright Designed By <a href="{{secure_url('/')}}"><span style="color: #178ddb;text-decoration: underline;">S2payment</span></a></p>
          </div>
        </div>
