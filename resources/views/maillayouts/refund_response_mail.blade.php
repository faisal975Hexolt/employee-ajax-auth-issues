            ...
            <table style="width:100%;max-width:600px;font-family:Arial;font-size:16px;color:#868686;table-layout:fixed;border: 1px solid rgb(167, 167, 167);" cellspacing="0" cellpadding="0" border="0">
             <thead>
               <th colspan="3">
                ...
                <br><br>We hope this message finds you well. We are writing to confirm that your refund has been successfully processed for the order with the number : {{$htmldata["transaction_id"]}} . <br>We sincerely apologize for any inconvenience you may have experienced, and we thank you for your patience throughout this process.

                <br><br>The details of your refund are as follows:

                <br><br>Payment ID: {{$htmldata["transaction_id"]}}
                <br>Refund Amount: {{$htmldata["refund_amount"]}}
                <br>Refund ID  - {{$htmldata["refund_id"]}}
                <br>Refund Bank Ref No -  {{$htmldata["refund_rrn"]}}
                <br><br>Thank you for choosing {{env('APP_NAME')}}.
