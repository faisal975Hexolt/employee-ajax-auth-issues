...
<header class="">
 ...
 <table style="border-collapse: collapse;max-width: 767px;width: 100%;text-align: center;margin: 0 auto;margin-bottom: 30px;">
        ...
        <thead class="background: #3097d1;">

            <th style="text-align: left;padding: 20px 0 20px 30px;font-size: 14px;line-height: 30px; font-weight: 400;">                

                <img src="<?=$data['company_img']?>" style="margin-top: 10px;" width="100px"> <br>

                   <?=ucfirst(strtolower('S2 PAYMENTS & TECH SOLUTIONS PRIVATE LIMITED'))?> <br>
    ...
    <table style="border-collapse: collapse;max-width: 767px;width: 100%;text-align: center;margin: 0 auto;">
        ...
        <tr>
            ...
            <td colspan="2" >
                ...
                <p style="font-size: 20px;color: #000000;font-weight: 600;text-align: center;"><?=ucfirst(strtolower('S2 PAYMENTS & TECH SOLUTIONS PRIVATE LIMITED'))?></p>
        ...
        <tr style="background: #F8F9FA;">
            ...
            <td colspan="2" style="font-size: 16px;color: #939393;font-weight: 400;text-align: center;">
                ...
                <p>No.150, 1st Floor, Sri Vedha Vinayagar, 

                    <br>Chellankuppam, Cuddalore OT,

                    Tamilnadu, India -607003</p>
    ...
    <table style="border-collapse: collapse;max-width: 767px;width: 100%;text-align: center;margin: 0 auto;margin-bottom: 30px;">
       ...
       <!--  <thead class="background: #FFFFFF;">
            ...
            <th style="text-align: left;padding: 20px 0 20px 30px">                
                ...
                <img src="<?=$data['company_img']?>">  Walkover Web Solutions Private Limited GSTIN23AAACW9768L1ZO            
    ...
    <table style="border-collapse: collapse;max-width: 767px;width: 100%;text-align: center;margin: 0 auto;margin-bottom: 25px;">
        ...
        <thead class="background: #FFFFFF;">
            ...
            <th style="text-align: right;font-size: 16px;color: #000000;font-weight: 600;padding-right: 35px">
                ...
                <p><span style="font-size: 16px;color: #939393;font-weight: 400;">For</span> <?=ucfirst(strtolower('S2 PAYMENTS & TECH SOLUTIONS PRIVATE LIMITED'))?></p>

                <img src="{!!$data['company_sign']!!}" alt="signature" style="height: 50px;padding-right: 45px;">
