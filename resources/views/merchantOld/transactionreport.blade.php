                ...
                <div class="col-sm-4 ">
                    ...
                    <div class="form-group">
                        ...
                        @foreach (\App\Classes\Helpers::transaction_report_types() as $type )
                                                <option {{ request()->input('table_name') == $type ? "selected" :""}} value="{{$type}}">{{ucwords($type)}}</option>
                                     @endforeach
               ...
               <div class="report_parameter">
                ...
                <div  class="col-sm-4"></div>
                      <div class="col-sm-4">
                            ...
                            <input class="form-control transaction_download_report"  
                        ...
                        <div class="col-sm-4 ">
                                <button type="submit" class="btn btn-primary submitButton"> Download</button>
                        </div>
                </div>
          </form>
        </div>
...
<div class="panel panel-default panelH panelW">
