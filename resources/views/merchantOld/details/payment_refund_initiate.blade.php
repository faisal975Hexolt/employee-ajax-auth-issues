...
<div class="row">
		...
		<form id="case-form-refund" method="post" class="card" action="{{route('refund_support')}}">
		  ...
		  <div class="row">
			...
			<div class="col-md-12">
			  ...
			  <div class="form-group">
                ...
                <input readonly id="customer_name" type="text" class="form-control" name="customer_name" value="{{$info['transaction_info']['transaction_username']}}" placeholder="Name">
			...
			<div class="col-md-6">
			  ...
			  <div class="form-group">
				...
				<input type="text" readonly id="customer_email" type="text" class="form-control" name="customer_email" value="{{$info['transaction_info']['transaction_email']}}" placeholder="Email">
			...
			<div class="col-md-6">
			  ...
			  <div class="form-group">
                ...
                <input readonly id="customer_mobile" type="text" class="form-control" name="customer_mobile" value="{{$info['transaction_info']['transaction_contact']}}" placeholder="Mobile" >
