                                ...
                                <div class="form-right">
                                    ...
                                    <div id="dynamic_container" class="dynamic">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="{{env('INFO_CONTATCT')}}" class="form-control" name="contactus_email" data-label="contact email" id="right-inp" />
                                        </div>
                                        <div class="input-group mt-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text br-15"><i class="fa fa-phone-square"></i></span>
                                            </div>
                                            <input type="text" placeholder="{{ env('SUPPORT_NUMBER') }}" class="form-control" name="contactus_mobile" data-label="contact mobile" id="right-inp2"/>
