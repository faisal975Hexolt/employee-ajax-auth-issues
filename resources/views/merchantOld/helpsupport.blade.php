                ...
                <div id="help" class="tab-pane fade in active">
                                ...
                                <div class="row ">
                                    <div class="col-sm-12">
                                        <div class="panel panel-default ">
                                            ...
                                            <div class="panel-body panelH">
                                                <div class="panel-group panelH" id="accordion" role="tablist" aria-multiselectable="true">
                                                    <div class="panel panel-default">
                    ...
                    <div id="support" class="tab-pane">
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="col-sm-2">
                                    <select name="page_limit" class="form-control marg" onchange="getSupportData($(this).val())">
