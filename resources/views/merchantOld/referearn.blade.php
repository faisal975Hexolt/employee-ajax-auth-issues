...
<section id="about-1" class="about-1">
  ...
  <p>You are just one step away from activating your account to accept domestic and international payments from your customers. We just need a few more details</p>
        ...
        <div class="col-lg-6" data-aos="zoom-in">
          <img src="{{ asset('assets/img/merchant-refer.png') }}" width="350" height="250" class="img-fluid" id="img-dash" alt="merchant-refer.png">
        </div>
      </div>
                                ...
                                <div class="col-sm-6" style="overflow:scroll">
                                    <div class="panel panel-default refer-div-height">
                                        <div class="panel-body">
                                            ...
                                            <p>
                                                <strong>{{env('APP_NAME_FULL')}} Refer & Earn </strong>works same as the most of the refer and earn schemes in the market.You can earn virtual money as much as you can
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                            <div class="col-sm-12">
                                                                <div class="col-sm-3">
                                                                    <!-- <a href="https://www.facebook.com/sharer/sharer.php?s=100&p[title]=&p[summary]=&p[url]={{urlencode('http://www.managepay.com/')}}&p[image]={{urlencode('http://www.managepay.com/images/final-logo.png')}}" target="_black"><i class="fa fa-facebook-official fa-lg pull-left" ></i></a> -->
