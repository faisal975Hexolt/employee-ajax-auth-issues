            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <ul class="nav nav-tabs" id="transaction-tabs">
                        @php
                            $trans = [
                                'reseller/settlement' => '<a data-toggle="tab" class="show-cursor"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row" style="margin-top:15px;">
                                                    <div class="col-sm-12 mb-5">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <form id="reseller-summary-brief-transaction-download-form"
                                                                action="{{ route('reseller.settlementsummaryDwnld') }}"
                                                                method="POST" role="form">
                                                                @csrf
                                                                <div class="tab-button">
                                                                    <button type="submit"
                                                                        class="btn btn-primary btn-md pull-right dwd-brief">
                                                                        Download</button>
                                                                </div>
                                                            </form>
                                                        </div>
...
<script>
    $(function() {
        ...
        var table = $('#summary_transactions_breif').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('reseller.getSettlementSummary') }}",
                data: function(d) {
                    // $(".loader_custom").show();
    ...
    $(document).on('click', '.dwd-brief', function(event) {
        ...
        var url = $('form#reseller-summary-brief-transaction-download-form').attr('action');
    ...
    $(document).on('submit', '#reseller-summary-brief-transaction-download-form', function(event) {
        event.preventDefault();
