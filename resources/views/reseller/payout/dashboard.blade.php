@php
    ...
    $merchantList = DB::table('merchant')->where('reseller_id', Auth::user()->id)->select('id','name')
        ->get()
        ->toArray();
        ...
        $(function() {
            ...
            function callingapis(start, end, merchantid) {
                $.ajax({
                    ...
                    url: '{{ url('/') }}/reseller/payout/payoutdashboardTransactionStats',
                    success: function(data) {

                        console.log('%cdashboard.blade.php line:183 object', 'color: #007acc;', data);

                        $('#gtv').html(data.transactionStats.successful_tamount);
            ...
            function callinggraphapi(start, end, merchantId) {
                $.ajax({
                    ...
                    url: "{{ url('/') }}/reseller/payout/payoutDashboardGraph",
