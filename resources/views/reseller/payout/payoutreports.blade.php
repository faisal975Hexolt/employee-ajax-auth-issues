    ...
    <div class="row panelH">
        <div class="col-sm-12">
            <div class="row" style="margin-top:15px;">
                <div class="col-md-12">
                    <form class="flex-container" id="payout_report_form">
                        {{ csrf_field() }}
                        <div class="col-sm-4">
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    table = $('#merchant-tranreport-table').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{ route('reseller.payout.getPayoutReportLog') }}",
                        },
                        order: [
                            [1, 'desc']
                        ],
                    ...
                    $(document).on('submit', '#payout_report_form', function(event) {
                        console.log('working');
                        event.preventDefault();

                        $.ajax({
                            type: "GET",
                            url: '{{ route('reseller.payout.payouttransactionReportDownload') }}',
                            data: $('#payout_report_form').serializeArray(),
                            async: false,
