<style>
    .rounded-border {
        ...
        /* Black border with a thickness of 2px */
        padding: 20px;
                            ...
                            <div class="box-body" style="">
                                ...
                                @if (!empty($info['transaction_info']->payment_datetime))
                                    <div class="row"
                                        ...
                                        <div class="col-sm-6 text-left item"
                                            style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            <b>{{ \Carbon\Carbon::parse($info['transaction_info']->payment_datetime)->format('m-d-Y h:i:s A') }}
                                            </b>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if (!empty($info['transaction_info']->bank_ref_no))
                                    <div class="row"
                                        ...
                                        <div class="col-sm-6 text-left item"
                                            style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                            <strong class="copy-to-clipboard-text"
                                                id="merchant_order_id">{{ $info['transaction_info']->bank_ref_no }}</strong>&nbsp;&nbsp;&nbsp;<span
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary rounded-border">
                            ...
                            <div class="box-body" style="">
                                ...
                                @if (!empty($info['transaction_info']->merchant_platform) && $info['transaction_info']->merchant_platform != 'Unknown')
                                    <div class="row"
                                        style="padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
                                        <div class="col-sm-6 text-right item"
                                            style="text-align: left; padding-top: 5px; padding-bottom: 5px; overflow-wrap: break-word;">
