...
@section('resellercontent')
        ...
        <div class="container-1">
            ...
            <div class="row">
                ...
                <div class="col-lg-6" data-aos="zoom-in" id="img-dash">
                    <img src="{{ asset('assets/img/report.png') }}" width="450" height="280" class="img-fluid"
                        alt="dash-bnr.png">
    ...
    <div class="src">
        <form id="gst-report-range-form">
            <input class="form-control" id="gst_report_range" name="gst_report_range" placeholder="MM/DD/YYYY"
                type="text" value="">
