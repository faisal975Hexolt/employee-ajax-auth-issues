            ...
            <div class="panel panel-default">
                <div class="panel-heading panelH">
                    <ul class="nav nav-tabs" id="transaction-tabs">
                        <li class="active"><a data-toggle="tab" class="show-cursor" data-target="#reseller-payments">Payments</a></li>
                        <li><a data-toggle="tab" class="show-cursor" data-target="#reseller-refunds">Refunds</a></li>
                        <li><a data-toggle="tab" class="show-cursor" data-target="#reseller-orders">Orders</a></li>
                        <li><a data-toggle="tab" class="show-cursor" data-target="#reseller-disputes">Disputes</a></li>
                    </ul>
                    </br>
                    <!-- <div>
                ...
                <div class="panel-body panelbdy margTop">
                    <div class="tab-content">
                        <div id="reseller-payments" class="tab-pane fade in active">
                            <div class="row transrow">
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <div class="col-sm-2">
                                            <select name="page_limit" class="form-control marg" onchange="setResellerTransactionsPage($(this).val())">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <form id="transaction-download-form" action="{{route('download-transactionlog')}}" method="POST" role="form">
                                               <div class="col-sm-8" id="dash_date_range_summary">
                                                 <input class="form-control" id="transaction_download_range_summary" name="transaction_download_range_summary" readonly placeholder="MM/DD/YYYY" type="text" value="">
                                                    <input type="hidden" name="trans_from_date" value="">
                                                    <input type="hidden" name="trans_to_date" value="">
                                                     <input type="hidden" name="perpage" value="10">
                                                     <input type="hidden" name="type" value="reseller" id="type">
                                                   <span class="src">
                                                    <i class="fa fa-calendar dash-fa-calendar-summary"></i></span>
                                                 </div>   
                                               
                                                <div class="col-sm-4">
                                                    <button type="submit" class="btn btn-primary btn-md">Download</button>
                                                </div>
                                                {{csrf_field()}}
                                            </form>
                        ...
                        <div id="reseller-refunds" class="tab-pane ">
                            <div class="row transrow">
                                <div class="col-sm-7">
                                    <div class="col-sm-2">
                                        <select name="page_limit" class="form-control marg1" onchange="getAllResellerPayments($(this).val())">
                                            @foreach($per_page as $index => $page)
                                            <option value="{{$index}}">{{$page}}</option>
                                        @endforeach
                                        </select>
                        ...
                        <div id="reseller-orders" class="tab-pane ">
                            <div class="row transrow">
                                 <div class="col-sm-7">
                                    <div class="form-group">
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-10">
                                            <form id="order-download-form" action="{{route('download-transactionlog')}}" method="POST" role="form">
                                               <div class="col-sm-8 ">      
                                                 <input class="form-control" id="order_download_range" name="order_download_range" readonly placeholder="MM/DD/YYYY" type="text" value="">
                        ...
                        <div id="reseller-disputes" class="tab-pane">
