...
<body>
    ...
    <div class="login-wrap">
        <div class="left-col-auth linear-gradient">
            <div class="auth-page-container">
                <a href="#" class="pay-flash-logo-white">
                    <img src="{{ asset('new/img/s2Pay_Logo_white.png')}}" width="250" alt="Pay Flash">
                </a>
        ...
        <div class="auth-form-container auth-signup-form-container">
            ...
            <form method="POST" autocomplete="off" id="reseller-register" >
                {{ csrf_field() }}
                <div class="auth-form-group name-control">
                    <input type="text" class="auth-form-control" name="first_name" id="name" placeholder="Name" value="{{ old('first_name') }}" onkeyup="validateName('first_name');">
                </div>
                ...
                <div class="auth-form-group password-control">
                    <input type="password" class="auth-form-control" name="password_confirmation" placeholder="Confirm Password">
                </div>
                ...
                <div class="flex-container">
                    <div class="checkbox">
                        <label>
                            ...
                            By clicking the checkbox, you agree to the <a href="{{env('TERM_CONDITION_URL')}}">Terms & Conditions</a></a>
                ...
                <p class="sign-up-txt">Already have an account? <a href="{{route('reseller.login')}}">Sign In</a></p>
            </form>
        </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="modalMobileVerifyReseller">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <form id="mobile-verification-reseller">
                                <div class="form-group row">
                                    <label for="otp_number" class="col-sm-4 col-form-label text-right">OTP No:</label>
                                    <div class="col-sm-8">
                                        <input id="otp_number" maxlength="10" type="text" class="form-control" name="otp_number" value="{{ old('otp_number') }}" placeholder="Enter 6 digit otp" onkeypress="return event.charCode >= 48 && event.charCode <= 57" >
