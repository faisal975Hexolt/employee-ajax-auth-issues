            ...
            <tr>
                ...
                <td>
                    @if ($settlement->settlement_receiptno)
                        <a target="_blank" href="{{ route('recipt', ['id' => $settlement->settlement_receiptno]) }}">
                            {{ $settlement->settlement_receiptno }}</a>
                    @endif
                ...
                <td>
                    <div class="col-sm-10">
                        <i class="fa fa-eye show-cursor mandatory"
                            onclick="gstInvoiceReort(this,'{{ $settlement->my_date }}');"></i>
                        <a target="_blank" href="{{ route('gstdetailExcelReseller', ['date' => $settlement->my_date]) }}"> <i
                                class=" fa fa-file-excel-o fa-lg" style="color:chocolate"></i></a>
