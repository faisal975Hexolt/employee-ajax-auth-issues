                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-sm-12">
                                    <form method="POST" autocomplete="off" class="form-horizontal" role="form" id="update-my-details">
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="old-name" name="first_name" value="{{$basicinfo->first_name}}" autocomplete="off" readonly disabled> 
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="last-name" name="last_name" value="{{$basicinfo->last_name}}" autocomplete="off" readonly disabled> 
                                            </div>
                                            <div class="col-sm-3">
                                                <button type="button" class="btn btn-primary btn-sm" onclick="ChangeMyLastName();">Change Name</button>
                                            </div>
                                        </div>
                                        <div class="form-group" id="dynamic-lname-div" style="display: none;">
                                            <label class="control-label col-sm-2" for="l-name">New Last Name:</label>
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="l-name" name="last_name" value="" autocomplete="off" disabled>
                                                <span id="last-name-ajax-response"></span>
                                            </div>
                                            <div class="col-sm-3">
                                                <button type="submit" class="btn btn-primary btn-sm">Save name</button>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" value="{{$basicinfo->email}}" autocomplete="off" readonly disabled>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="old-mobile" value="{{$basicinfo->mobile_no}}" autocomplete="off" readonly disabled>
                        ...
                        <div id="change-password" class="tab-pane fade {{$activetab == '' && session('tab-active')?'in active':''}}">
                            <div class="row {{!session('current-password-form')?'':'hide'}}">
                                <div class="col-sm-12">
                                    <form action="{{route('reseller-change-password')}}" autocomplete="off" method="POST" class="form-horizontal" id="my-current-password">
                                        <div class="form-group">
                            ...
                            <div class="row {{session('change-password-form')?'':'hide'}}">
                                <div class="col-sm-12">
                                    <form action="{{route('reseller-change-password')}}" method="POST" class="form-horizontal" id="reseller-password-change">
                                        <div class="form-group">
