        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="sub-footer">
                    <p>&copy; Copyright 2023 <strong>{{env('APP_NAME')}}</strong>

                    | Powered by <strong>{{env('APP_NAME')}}</strong></p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="col-md-8">
                                    <div id="dynamic_container" class="dynamic" style="{{$page_details['contactus_enable'] == 'Y'?'display:block':''}}">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="contactus_email" placeholder="{{env('INFO_CONTATCT')}}" value="{{$page_details['contactus_email']}}" class="form-control" id="right-inp" />
                                        </div>
                                        <div class="input-group mt-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text br-15"><i class="fa fa-phone-square"></i></span>
                                            </div>
                                            <input type="text" name="contactus_mobile" placeholder="{{ env('SUPPORT_NUMBER') }}" value="{{$page_details['contactus_mobile']}}" class="form-control" id="right-inp2"/>
                                        </div>
                                        <div class="input-group">
                                            <span><button class="btn-transremove" id="contact-us-close">Remove</button></span>
                                        </div>
