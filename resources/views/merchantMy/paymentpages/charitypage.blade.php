                        ...
                        <form class="form-detail" method="post" id="page-detail">
                              ...
                              <div class="col-md-8">
                                 <div id="contactus-div" class="contactus">
                                    ...
                                    <div class="input-group">
                                          ...
                                          <input type="text" name="contactus_email" placeholder="{{ env('COMPANY_CONTATCT') }}" class="form-control" id="right-inp" />
                                    </div>
                                    <div class="input-group mt-3">
                                          <div class="input-group-prepend">
                                             <span class="input-group-text br-15"><i class="fa fa-phone-square"></i></span>
                                          </div>
                                          <input type="text" name="contactus_mobile" placeholder="{{ env('SUPPORT_NUMBER') }}" class="form-control" id="right-inp2"/>
                                    </div>
                                    <div class="input-group">
                           ...
                           <div class="d-flex flex-column bd-highlight mb-3 " style="color: #250061;">
                              <div class="bd-highlight">
                                 <img src="{{asset('new/img/S2PAY_Logo.png')}}" height="60" width="60"> <span class="power" style="color: #250061;"><b>  Powered by {{env('APP_NAME_FULL')}}</b></span>
                              </div>
                           </div>
                            ...
                            <div class="d-flex">
                               <div class="d-flex bd-highlight p-3">
                                  <div class="align-items-center">
                                     <a href="#" target="_blank"><img src="{{asset('images/managepay-pci.png')}}" width="60" class="rounded mx-auto d-block" alt="managepay-pci.png"></a>
                                  </div>
                             ...
                             <div class="col-md-8">
                                <div id="contactus-div" class="contactus" style="{{$page_details['contactus_enable'] == 'Y'?'display:block':'display:none'}}">
                                   ...
                                   <div class="input-group">
                                         ...
                                         <input type="text" name="contactus_email" placeholder="info@managepay.com" class="form-control" id="right-inp" value="{{$page_details['contactus_email']}}"/>
                                   </div>
                                   <div class="input-group mt-3">
                                         <div class="input-group-prepend">
                                            <span class="input-group-text br-15"><i class="fa fa-phone-square"></i></span>
