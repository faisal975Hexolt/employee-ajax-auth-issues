                    ...
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="invoice-edit-form"> 
                            <div class="row padding-20">
                                ...
                                <hr>
                                        <div class="pull-left padding-20">
                                            <button type="button" id="add-items" class="btn btn-primary btn-sm">Add Items</button>
                                        </div>
                                        <div class="pull-right padding-20">
                                            <button id="add-invoice-items" class="btn btn-primary btn-sm">Add Item Row</button>
                                        </div>
                
                                        <div class="col-sm-12" style="text-align:center">  <strong>Items List:</strong></div>
                            <div class="form-group" >
                                <div class="col-sm-12">
                                        ...
                                        <tbody id="dynamic-item-list">
                                            ...
                                            @foreach($items_details as $index => $details)
                                                <tr id="invoice_item_row{{$index+1}}">
                                                    <td>
                                                        <div class="col-sm-10">
                                                            <select name="item_name[]" id="item_name{{$index+1}}" class="form-control col-sm-12 item_name_list" onchange="itemCalculate(this);" data-name-id='{{$index+1}}'>
...
<div id="invoice-update-response-message-modal" class="modal fade">
  ...
  <!--Item Add Modal -->
  <div class="modal" id="add-item-modal" role="dialog">
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div id="add-item-response-message" class="text-center"></div>
                                        <form class="form-horizontal" id="add-item-form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <div id="item_name_0" class="form-error"></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">          
                                                    ...
                                                    <div id="item_amount_0" class="form-error"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">          
                                                <Textarea class="form-control" cols="25" rows="2" name="item_description[]"></Textarea>
                                                <div id="item_description_0" class="form-error"></div>
                                                </div>
