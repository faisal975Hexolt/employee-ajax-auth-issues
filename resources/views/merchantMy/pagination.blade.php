        ...
        @inject('refund', 'App\Refund')
            @if(count($transactions)>0)
                ...
                <tr>
                    ...
                    <td>{{$transaction->percentage_charge}}</td>
                    <td>{{$transaction->percentage_amount}}</td>
                    <td>{{$transaction->transaction_gst}}</td>
                    <td>{{$transaction->gst_charge}}</td>
                    <td>{{$transaction->total_amt_charged}}</td>
                    <td>{{$transaction->adjustment_total}}</td>
