...
<link href="https://mrm.s2pay.in/css/fonts.css" rel="stylesheet">
                    ...
                    <div class="box-header with-border">
                        <div class="col-sm-6 no-padding">
                            <div class="form-group" id="report_selection_range_id">
                                <label for="dashboard_selection_range" class="control-label col-sm-4 required"
                                    style="padding-top:5px;">Select date range:</label>
                                <div class="col-sm-8 no-padding">

                                    <form id="dashboard-form-payout">

                                        <input class="form-control datepicker" id="dash_date_range_payout"
                                            name="dash_date_range_payout" placeholder="MM/DD/YYYY" type="text" value="">
