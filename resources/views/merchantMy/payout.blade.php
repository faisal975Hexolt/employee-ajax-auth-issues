...
<div class="row" style="margin-left:15px;">
    ...
    <div class="col-12 wrap1">



        <table id="Payouttransactiontbl" class="table table-striped" style="width:100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($transaction->created_at)->format('d-m-Y g:i A')}}</td>
                     ...
                     @if($transaction->system_reference_number)   

                                 <td id="transactiongid">
                                    <a href="javascript:payouttransactionDetailsView('{{$transaction->id}}')">{{$transaction->system_reference_number}}</a>
                                 </td>
                     @else
                            
                            <td id="transactiongid">
                                <a href="javascript:payouttransactionDetailsView('{{$transaction->id}}')">{{$transaction->transfer_id}}</a>
                            </td>
                     @endif
                    ...
                    <td>{{$transaction->vendor_charges?? '0.00'}}</td>

                    <td>{{$transaction->goods_service_tax?? '0.00'}}</td>

                    <td>{{$transaction->reponse_error_message?? ''}}</td>
