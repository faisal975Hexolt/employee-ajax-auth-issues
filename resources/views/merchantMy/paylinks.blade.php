...
<section id="about-1" class="about-1">
    ...
    <div class="row">
        ...
        <img src="{{ asset('assets/img/merchant-paylink.png') }}" width="400" height="250" class="img-fluid" id="img-dash" alt="merchant-paylink.png">
        </div>
    </div>
                ...
                <div class="tab-content">
                    <div id="paylinks" class="tab-pane fade in active">
                        <div class="tab-button">
                            <div id="addpaylinkmodal" class="btn btn-primary btn-md">Add Paylink</div>     
                        </div>
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="col-sm-2">
                                    <select name="page_limit" class="form-control marg" onchange="getAllPaylinks($(this).val())">
                                        ...
                                        <div class="tab-content">
                                            <div id="add-paylink" class="tab-pane fade in active">
                                                ...
                                                <form class="form-horizontal" id="paylinkadd" autocomplete="off">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="control-label col-sm-2" for="customeremail">Customer Email:<span class="mandatory">*</span></label>
                                                    <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="control-label col-sm-2" for="customermobile">Customer Mobile:<span class="mandatory">*</span></label>
                                                    <div class="col-sm-4">
                                                    ...
                                                    <label class="control-label col-sm-3 hide" for="sendmessage">Partail Payment</label>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control show-pointer datetimepicker" name="paylink_expiry" id="paylink_expiry" value="" readonly/>
                                                        ...
                                                        <input type="hidden" class="form-control show-pointer" name="paylink_expiry1" id="paylink_expiry1" value=""/>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-offset-2 col-sm-4">
                                                        <button type="submit" id="paylink-add" class="btn btn-success btn-block disabled">Submit</button>
                                                    </div>
                                                    </div>
                    ...
                    <div id="quicklinks" class="tab-pane fade">
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="col-sm-2">
                                    <select name="page_limit" class="form-control marg" onchange="getAllQuickLinks($(this).val())">
                                        @foreach($per_page as $index => $page)
                                        <option value="{{$index}}">{{$page}}</option>
                                    @endforeach
                                    </select>
