            ...
            <div class="panel panel-default">
                <div class="panel-heading panelH">
                    ...
                    <div >
                        ...
                        <div class="col-sm-4" id="dash_date_range_summary">
                            ...
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-primary btn-md"><i class="fa fa-download"></i> Download</button>
                            </div>
                            {{csrf_field()}}
                        </form>
                    ...
                    <button class="btn btn-md btn-primary" id="downloadTrnsBtn" onclick="downloadTransactionSett()" style="float:right;margin-right:14px"> <i class="fa fa-download"></i> Download CSV</button></br></br>
