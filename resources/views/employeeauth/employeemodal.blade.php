...
<div class="modal-body">
    <div class="row">
        <div class="col-sm-12 text-center pb-3">
            <img src=" {{ asset('assets/img/forget-password.png') }}" width="280" height="130" alt="forget-password" class="rounded-circle img-responsive">
        </div>
    </div>
    <div class="row">
        <div class="col-sm-10 offset-sm-2 pt-3 pb-3">
...
@if(isset($token_factory_auth) && $token_factory_auth == 1)
<div class="modal-header bg-info">
    <h5 class="modal-title text-light">Two Factor Authentication</h5>
    <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-sm-10 offset-sm-2 pt-3 pb-3">
            <span id="success-body" class="text-sm-center" style="color: green;">Kindly check Authenticator app for login 6 digit code</span>
            <span id="error-body" class="text-sm-center"></span>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <form id="authenticator-otp-form" method="POST">
              <div class="form-group row">
                <label for="email-otp" class="col-sm-1 offset-sm-2 col-form-label text-right">OTP:</label>
                <div class="col-sm-8 offset-sm-1">
                  <input type="text" class="form-control" id="auth-otp" name="auth_otp">
                  <span id='auth_otp_ajax_error'></span>
                </div>
              </div>
              {{csrf_field()}}
              <div class="form-group row">
