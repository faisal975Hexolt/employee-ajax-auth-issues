     ...
     public function doGet($url, $headers){
      ...
      public  function initiate_refund($data)
      {
       ...
       if($res['code']==200){
            ...
            $refund= new CfRefund();
            $refund['manage_transaction_gid']=$order_id;
            $refund['merchant_id']=$merchant_id;
            $refund['manage_payment_id']=$data['payment_id'];
      ...
      public  function get_order_settlements($order_id)
      {
       ...
       if($res['code']==200){
        ...
        $settlementData=$settlement
                   ->where('manage_transaction_gid',$order_id)
        ...
        if($settlementData){
            ...
            $settlement->manage_transaction_gid=$order_id;
