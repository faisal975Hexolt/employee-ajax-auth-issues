...
class ResellerFileExportJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        var_dump('job hit start');
        $mtans = new \App\Exports\ReportPaymentExport();
        return $mtans->reseller_file_export_payment($this->report_filter, $this->filename, $this->logId);
    }
