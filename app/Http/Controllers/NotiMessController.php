...
class NotiMessController extends Controller
{
    ...
    public function get_reseller_table_notification()
    {
        $notification = $this->get_merchant_appmode(Auth::user()->app_mode);
        return $notification->get_reseller_notifications();
    }
    public function get_reseller_table_messages()
    {
        $notification = $this->get_merchant_appmode(Auth::user()->app_mode);
        return $notification->get_reseller_messagess();
    }
    public function view_all_reseller_notifications()
    {
        $notification = $this->get_merchant_appmode(Auth::user()->app_mode);
        return $notification->update_reseller_notifications();
    }
    public function view_all_reseller_messages()
    {
        $notification = $this->get_merchant_appmode(Auth::user()->app_mode);
        return $notification->update_reseller_messages();
    }
}
