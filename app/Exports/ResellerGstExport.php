...
class ResellerGstExport implements FromCollection, WithMapping, WithHeadings
{
    public $reportData;
...

    {
        ...
        $merchant_id = Merchant::where('reseller_id', Auth::user()->id)->pluck('id')->toArray();
        $db = Settlement::whereIn('created_merchant', $merchant_id);
