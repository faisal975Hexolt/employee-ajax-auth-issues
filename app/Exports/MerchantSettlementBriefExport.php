...
class MerchantSettlementBriefExport implements FromQuery, WithHeadings, WithChunkReading, WithMapping, WithColumnFormatting
{
    use Exportable;
    ...
    public function query()
    {
        ...
        return $payment->query()->select([
            'settlement_brief_gid', $paymentTable . '.created_merchant',
    ...
    public function map($transaction): array
    {
        ...
        return [
            ...
            $transaction->transaction_total_refunded ?? 0,
