...
function setSupplierValues(selectElement) {
    ...
    if (supplierid != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/account/purchase-order/get-supplier/" + supplierid,
            dataType: "json",
...
function getAllPurchaseOrders() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/payable-management/purchasae-order/get-all-purchase-order/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getItems() {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/invoice/item/get-item-options",
        dataType: "json",
        success: function (response) {
...
$("#porder_save").click(function (e) {
    ...
    if (formvalidate && id == undefined) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/purchase-order/new",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/purchase-order/update",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function getPurchaseOrderItems(selectElement) {
    ...
    if (purchaseid != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/account/payable-management/suporder-invoice/get-purchase-order-items/" + purchaseid,
            dataType: "html",
            success: function (response) {
...
function getAllSupOrderInvoice() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/payable-management/suporder-invoice/get-all-suporder-invoice/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#suporder_save").click(function (e) {
    ...
    if (formvalidate && id == undefined) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/suporder-invoice/new",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/suporder-invoice/update",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function getAllSupExpInvoice(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/payable-management/supexp-invoice/get-all-supexp-invoice/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#supexp_save").click(function (e) {
    ...
    if (formvalidate && id == undefined) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/supexp-invoice/new",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/supexp-invoice/update",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function getAllSupNotes(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/payable-management/debit-note/get-all-supcd-note/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#supplier-note-form").submit(function (e) {
    ...
    if (formvalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/debit-note/new",
...
$("#edit-supplier-note-form").submit(function (e) {
    ...
    if (formvalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/payable-management/debit-note/update",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function setCustomerValues(selectElement) {
    ...
    if (customerid != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/account/receivable-management/sales-order/get-customer/" + customerid,
            dataType: "json",
            success: function (response) {
                $.each(response[response.length - 1], function (indexInArray, valueOfElement) {
...
function getAllSalesOrders() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/receivable-management/sales-order/get-all-sales-order/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#sorder_save").click(function (e) {
    ...
    if (formvalidate && id == undefined) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/receivable-management/sales-order/new",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/receivable-management/sales-order/update",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function getSalesOrderItems(selectElement) {
    ...
    if (salesorderid != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/account/receivable-management/custorder-invoice/get-sales-order-items/" + salesorderid,
            dataType: "html",
            success: function (response) {
...
function getAllCustOrderInvoice() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/receivable-management/custorder-invoice/get-all-custorder-invoice/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#custorder_save").click(function (e) {
    ...
    if (formvalidate && id == undefined) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/receivable-management/custorder-invoice/new",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/receivable-management/custorder-invoice/update",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function getAllCustNotes() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/receivable-management/debit-note/get-all-custcd-note/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#customer-note-form").submit(function (e) {
    ...
    if (formvalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/receivable-management/debit-note/new",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
$("#edit-customer-note-form").submit(function (e) {
    ...
    if (formvalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/account/receivable-management/debit-note/update",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function getAllassets() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/fixed-asset/get-all-assets/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-asset-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/fixed-asset/new",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function editAsset(assetid) {
    ...
    if (assetid != "") {
        $.ajax({
            url: base_phpurl + "/manage/account/fixed-asset/edit/" + assetid,
            type: "GET",
            dataType: "json",
            success: function (response) {
...
$("#update-asset-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/fixed-asset/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllCapitalassets() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/fixed-asset/get-all-capital-assets/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-capital-asset-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/fixed-asset/capital/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllDepreciateassets() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/fixed-asset/get-all-depreciate-assets/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-depreciate-asset-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/fixed-asset/depreciate/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllSaleassets() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/fixed-asset/get-all-sale-assets/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-sale-asset-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/fixed-asset/sale/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllTaxSettlement() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/global-taxation-solution/tax-settlement/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getAllTaxAdjustment() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/global-taxation-solution/tax-adjustment/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getAllTaxPayment() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/global-taxation-solution/tax-payment/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#tax-settlement-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/account/global-taxation-solution/tax-settlement/new",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#tax-adjustment-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/account/global-taxation-solution/tax-adjustment/new",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#tax-payment-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/account/global-taxation-solution/tax-payment/new",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllVouchers() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/vouchers/get-all-vouchers/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-voucher-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/voucher/new",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function editVoucher(voucherid) {
    if (voucherid != "") {
        $.ajax({
            url: base_phpurl + "/manage/account/voucher/edit/" + voucherid,
            type: "GET",
            dataType: "json",
            success: function (response) {
                if (response.length > 0) {
...
$("#update-voucher-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/voucher/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllChartAccount() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/charts-account/get-chart/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getAllInvoices() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/invoice/invoices/get-all-invoices/" + perpage,
        dataType: "html",
        success: function (response) {
...
function optionItems() {
    invoiceItemOptions = [];
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/invoices/get-all-items-options",
        type: "GET",
        dataType: "json",
        success: function (response) {
            var html = '';
...
function optionCustomers(option = "") {
    ...
    var customer_id = "";
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/invoices/get-all-customer-options",
        type: "GET",
        dataType: "json",
        success: function (response) {
...
function getCustomerAddress(customerid, formid) {
    customerAddress = [];
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/invoice/get-customer-info/" + customerid,
        type: "GET",
        dataType: "json",
        success: function (response) {
...
$("#add-edit-customer-address-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/invoice/customer-address/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
$("#add-customer-address-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/invoice/customer-address/add",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function updateInvoice(value) {
    ...
    if (isformvalid) {
        $.ajax({
            url: base_phpurl + "/manage/account/invoice/invoices/update",
            type: "POST",
            data: formdata,
            dataType: "json",
            success: function (response) {
...
function addInvoice(value) {
    ...
    if (isformvalid) {
        $.ajax({
            url: base_phpurl + "/manage/account/invoice/invoices/new",
            type: "POST",
            data: formdata,
            dataType: "json",
            success: function (response) {
...
$("#itemadd").submit(function (e) {
    ...
    if (fromvalidate) {
        $.ajax({
            url: base_phpurl + "/manage/account/invoice/item/new",
            type: "POST",
            data: formdata,
            dataType: "json",
            success: function (response) {
...
function editItem(itemid) {
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/item/edit/" + itemid,
        type: "GET",
        dataType: "json",
        success: function (response) {
            if (response.length > 0) {
...
$("#item-update-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/item/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
$("#item-delete-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/item/destroy",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllCustomers() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/invoice/customers/get-all-customers/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-customer-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/customer/new",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function editCustomer(customerid) {
    ...
    if (customerid != "") {
        $.ajax({
            url: base_phpurl + "/manage/account/invoice/customer/edit/" + customerid,
            type: "GET",
            dataType: "json",
            success: function (response) {
                if (response.length > 0) {
...
$("#update-customer-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/customer/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
$("#delete-customer-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/customer/destroy",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllSuppliers() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/invoice/suppliers/get-all-suppliers/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-supplier-form").submit(function (event) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/supplier/new",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function editSupplier(supplierid) {
    ...
    if (supplierid != "") {
        $.ajax({
            url: base_phpurl + "/manage/account/invoice/supplier/edit/" + supplierid,
            type: "GET",
            dataType: "json",
            success: function (response) {
                if (response.length > 0) {
...
$("#update-supplier-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/supplier/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
$("#delete-supplier-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/account/invoice/supplier/destroy",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllItems() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/account/invoice/items/get-all-items/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getChartAccountOptions(formid, name) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/get-chart-options",
        dataType: "json",
        success: function (response) {
            if (response.length > 0) {
...
function getSingleChartAccount(chartid) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/edit-chart-record/" + chartid,
        dataType: "json",
        success: function (response) {
            if (response.length > 0) {
                $.each(response[response.length - 1], function (indexInArray, valueOfElement) {
...
$("#chart-account-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/account/charts-account/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllContraEntry() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/finance/payable-management/contra-entry/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getInvoiceNo(element) {
    ...
    if (invoice_type_id != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/finance/payable-management/sundry-payment/get/invoice-no/" + invoice_type_id,
            dataType: "json",
            success: function (response) {
...
function getAllSupPayBatchEntry() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/finance/payable-management/supplier-paybatch/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#sup-pay-entry-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/supplier-paybatch/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#update-sup-pay-entry-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/supplier-paybatch/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllSundryPaymentEntry() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/finance/payable-management/sundry-payment/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#sund-pay-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/sundry-payment/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#update-sund-pay-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/sundry-payment/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#contra-entry-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/contra-entry/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#update-contra-entry-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/contra-entry/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#bank-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/bank/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllBanks() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/finance/payable-management/bank/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
function editBankInfo(sno) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/finance/payable-management/bank/edit/" + bankid,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
...
$("#edit-bank-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/payable-management/bank/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getSaleInvoiceNo(element) {
    ...
    if (invoice_type_id != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/finance/receivable-management/cust-dreceipt-entry/get/invoice-no/" + invoice_type_id,
            dataType: "json",
            success: function (response) {
                invoiceOptions.push("<option>--Select--</option>");
                if (Object.keys(response).length > 0) {
...
function getAllCustReceiptEntries() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/finance/receivable-management/cust-dreceipt-entry/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getAllSundReceiptEntry() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/finance/receivable-management/sundry-receipt/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#cust-recipt-entry-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/receivable-management/cust-dreceipt-entry/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#update-cust-recipt-entry-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/receivable-management/cust-dreceipt-entry/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#sund-receipt-entry-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/receivable-management/sundry-receipt/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#update-sund-receipt-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/finance/receivable-management/sundry-receipt/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getMerchantTransactions(element) {
    ...
    if (merchantid != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/settlement/get-merchants-transactions/" + merchantid,
            dataType: "json",
            success: function (response) {
...
function getMerchantTransactionsByDate() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/settlement/get-all-transactions",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function (response) {
...
function getAllPayments($val) {
    $(".loader").show();
    $("#transaction-form-perpage").val($val);

    getMerchantTransactionsByDate();

}
function getAllPaymentsByMerchant($val) {
    if ($val == 'all') { $val = ''; }
    $(".loader").show();
    $("#transaction-form-search-m").val($val);
    $("#trans_merchant").val($val);
    getMerchantTransactionsByDate();
...
function getTransactionsDetails(element) {
    ...
    if (transactionid != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/settlement/get-transactions-details/" + transactionid,
            dataType: "json",
            success: function (response) {
                if (response.length > 0) {
...
$("#add-settlement-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/settlement/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAdjustmentDetails() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/settlement/get",
        dataType: "html",
        success: function (response) {
...
$("#adjustment-report-form").submit(function (e) {
    ...
    if (formvalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/settlement/generate",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function merchantAdjustment(adjustmentid, merchant_id) {
    if (adjustmentid != "") {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/settlement/proceed-adjustment",
...
function selectAllVendorAdjustmentIds(element) {
    var checkboxes = $("#managepay-adjustment-form input[name='id[]']");
...
function bulkVendorAdjustment() {
    ...
    if (Object.keys(formdata).length > 1) {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/settlement/transactions-details",
            data: formdata,
            dataType: "json",
            success: function (response) {
                $.each(response, function (index, object) {
...
function bulkS2paymentAdjustment() {
    //var formdata = $("#managepay-adjustment-form").serializeJSON();
    var formdata = $("#settle-transactions-form").serializeJSON();
    if (Object.keys(formdata).length > 1) {
        var html = "";
        showLoader();
        $("#managepay-adjustment-response-rows").html(html);
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/settlement/manage-adjustment",
            data: formdata,
            dataType: "json",
            success: function (response) {
                $.each(response, function (index, object) {
                ...
                $("#managepay-adjustment-response-rows").html(html);
                $("#managepay-adjustment-add-response-message-modal").modal({ show: true, backdrop: "static", keyboard: false });
                getVendorAdjustment();
            },
            complete: function () {
                hideLoader();
...
function getVendorAdjustment() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/settlement/get-vendor-adjustments",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function (response) {
...
$("[data-target='#managepay-adjustments']").click(function (e) {
    e.preventDefault();
    getS2paymentAdjustmentByDate();
});

function getS2paymentAdjustmentByDate() {
    var formdata = $("#managepay-adjustment").serializeArray();
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/settlement/get-managepay-adjustments",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function (response) {
...
function getAllCDRTransactions(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/settlement/chargeback-dispute-refund/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#cdr-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/settlement/chargeback-dispute-refund/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#update-cdr-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/settlement/chargeback-dispute-refund/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllApprovedMerchants(perpage = 10) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/technical/get-apporved-merchants/" + perpage,
        dataType: "html",
        success: function (response) {
...
function MakeMerchantLive(id, element) {
    ...
    Swal.fire({
        title: 'Do you want to Make Merchant Live?',
        showDenyButton: true,
        ...
        if (result.isConfirmed) {
            ...
            $(".loader").show();
            var status = $(element).data("merchantstatus");
            $.ajax({
                type: "GET",
                url: base_phpurl + "/manage/technical/make-merchant-live/" + id,
                dataType: "json",
                success: function (response) {
...
function MakeMerchantInactive(id, element) {
    ...
    Swal.fire({
        title: 'Do you want to Change Merchant Status?',
        showDenyButton: true,
        // showCancelButton: true,
        confirmButtonText: 'Yes',
        denyButtonText: 'No',
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "GET",
                url: base_phpurl + "/manage/technical/change-merchant-status/" + id + "/" + status,
                dataType: "json",
                success: function (response) {
                    //   $("#modal-message").html(response.message);

                    if (response.merchant_status == 'inactive') {
                        $(element).parent("td").parent("tr").find("td:nth-child(9)").html(response.merchant_status);
                        ...
                        $(element).parent("td").parent("tr").find("td:nth-child(9)").html(response.merchant_status);
                        $(element).hide();
                        $(element).parent("td").find("button:nth-child(2)").show();

                        $(element).parent("td").find("button:nth-child(2)").data('merchantstatus', response.merchant_status);
                    }
                    swalnot(response.type, response.message)
                    // $("#ajax-response").modal({ show: true, backdrop: "static", keyboard: false });
                },
...
function merchantCharges(perpage = 10) {
    url = base_phpurl + "/manage/technical/get-merchant-charges/" + perpage;
    dataOutput = "html";
    ajaxGETCall(url, dataOutput, merchantChargesSuccess, merchantChargesComplete);
}

$(document).ready(function () {
    var perpage = 10; // Define the number of items per page

    $('#merchant_for_merchant_charge').change(function () {
        var selectedValue = $(this).val();

        // Make an AJAX request based on the selected value
        if (selectedValue) {
            var url = base_phpurl + "/manage/technical/get-merchant-charges/" + perpage; // Adjust the URL as per your route configuration
            var requestData = { id: selectedValue }; // Assuming 'id' is the parameter expected by the backend
...
$("#call-merchant-charges-modal").click(function (e) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/technical/get-merchant-charge/" + recorid,
        dataType: "json",
        success: function (data) {
            $('#cat_view').html(null);
            $('#cat_view').html(data.view);
        }
...
$(document).on('click', '.AddMerchant_id', function (e) {
    e.preventDefault();
    var mid = $(this).val();
    if (mid) {
        $('#cat_view').html(null);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                b = $("#merchant-charges-form select[name=business_type_id]");
...
function updateMerchantOptions() {
    var merchantSelect = $("#merchant_list_routing");

    if (merchantSelect.length > 0) {

    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/technical/get-merchant-list_routing",
        dataType: "json",
        success: function (response) {
            var merchantSelect = $("#merchant_list_routing");
...
$("#merchant-routing-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/technical/add-merchant-route",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function editMerchantRoutes(recorid) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/technical/get-merchant-route/" + recorid,
        dataType: "json",
        success: function (response) {
            if (typeof response != "undefined" && Object.keys(response).length > 0) {
                $.each(response[response.length - 1], function (key, value) {
...
function getMerchantBusinessType(element, formName) {
    ...
    if (merchant_id != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/technical/get-merchant-business-type/" + merchant_id,
            dataType: "json",
            success: function (response) {
                if (typeof response != undefined && Object.keys(response).length > 0) {
...
function updateMerchantListCharges() {

    var merchantSelect = $(".merchant_list_for_charges");

    if (merchantSelect.length > 0) {

    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/technical/merchant_list_for_add_charges",
        dataType: "json",
        success: function (response) {
            var merchantSelect = $(".merchant_list_for_charges");
            merchantSelect.empty(); // Clear current options
...
$("#merchant-charges-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/technical/merchant-charge/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            updateMerchantListCharges();
            if (response.status) {
                ...
                $("#merchant-charges-modal").modal('hide');
                merchantCharges();
            } else {
...
$("#callmerchantaccountantmodal").click(function (e) {
    console.log('modal acc')
    e.preventDefault();
    $("#merchantaccountantmodal").modal({ show: true, backdrop: "static", keyboard: false });
});
...
$("#adjustment-charges-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/technical/adjustment-charge/add-update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function editadjustmentCharges(recordId) {
    ...
    if (recordId != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/technical/get-adjustment-charge/" + recordId,
            dataType: "json",
            success: function (response) {
                if (typeof response != "undefined" && Object.keys(response).length > 0) {
                    $.each(response[response.length - 1], function (key, value) {
...
function getMerchantAdjustmentcharges(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/technical/get-adjustment-charges/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getMerchantRouting(perpage = 10) {
    var selectedValue = $(`#merchant_for_merchant_route`).val();
    var requestData = { id: selectedValue };

    $.ajax({
        type: "GET",
        data: requestData,
        url: base_phpurl + "/manage/technical/get-merchant-routes/" + perpage,
        dataType: "html",
        success: function (response) {
...
$(document).ready(function () {
    ...
    $('#merchant_for_merchant_route').change(function () {
        var selectedValue = $(this).val();

        // Make an AJAX request based on the selected value
        if (selectedValue) {
            var url = base_phpurl + "/manage/technical/get-merchant-routes/" + perpage; // Adjust the URL as per your route configuration
            var requestData = { id: selectedValue }; // Assuming 'id' is the parameter expected by the backend
...
$("[data-target='#usage-settings']").click(function (e) {
    e.preventDefault();
    $(".loader").show();
    getMerchantUsages();
});

function getMerchantUsages(perpage = 10) {
    var selectedValue = $('#merchant_for_merchant_usage').val();
    var requestData = { id: selectedValue };
    $.ajax({
        type: "GET",
        data: requestData,
        url: base_phpurl + "/manage/technical/get-merchant-usages/" + perpage,
        dataType: "html",
        success: function (response) {
            $("#paginate_merchantusage").html(response);
            $(".loader").hide();
        }
    });
}
...
$(document).ready(function () {
    ...
    $('#merchant_for_merchant_usage').change(function () {
        var selectedValue = $(this).val();

        // Make an AJAX request based on the selected value
        if (selectedValue) {
            var url = base_phpurl + "/manage/technical/get-merchant-usages/" + perpage; // Adjust the URL as per your route configuration
            var requestData = { id: selectedValue }; // Assuming 'id' is the parameter expected by the backend
...
function getCashFreeRouting(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/technical/cashfree-getroutes/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#cashfree-routing-form").submit(function (e) {
    ...
    if ($("#cashfree-routing-form input[name='id'").val() == "") {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/technical/cashfree-add-route",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
        ...
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/technical/cashfree-update-route",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function editCashFreeKey(id) {
    ...
    if (id != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/technical/cashfree-edit-route/" + id,
            dataType: "json",
            success: function (response) {
...
function getMerchantStatus() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/support/merchant/status",
        dataType: "html",
        success: function (response) {
...
function getMerchantSupport() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/support/merchant/support-list",
        dataType: "html",
        success: function (response) {
...
$("#support-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/support/call-list/merchant-support/add",
        type: "POST",
        data: data,
        processData: false,
        contentType: false,
...
$("#call-support-from").submit(function (e) {
    ...
    if (formvalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/support/call-list/support/new",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function getAllCallSupports() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/support/call-list/support/get",
        dataType: "html",
        success: function (response) {
...
function getAllLockedAccounts() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/support/merchant/locked-accounts/get",
        dataType: "html",
        success: function (response) {
...
function unlockMerchantAccount(merchantId) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/support/merchant/unlock-account/" + merchantId,
        dataType: "json",
        success: function (response) {
...
function addPost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/add-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
function getAllPost() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/get-all-posts",
        dataType: "html",
        success: function (response) {
...
function editPost(id) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/edit-post/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
...
$("#remove-blog-image").click(function (e) {
    ...
    if (confirm('You can not undo this action click ok to continue')) {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/marketing/remove-post-image/" + imageName,
            data: "data",
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function updatePost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/update-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
$("#delete-post-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/remove-post",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            getAllPost();
...
function getAllContactus(perpage = 10) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merketing/contact/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getAllSubscribe(perpage = 10) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merketing/subscribe/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getGalleryImages(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merketing/gallery/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-gallery-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/merketing/gallery/add",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
function editGalleryImage(imageid) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merketing/gallery/edit/" + imageid,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[response.length - 1], function (key, value) {
...
$("#remove-gallery-image").click(function (e) {
    ...
    if (confirm('You can not undo this action click ok to continue')) {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/marketing/remove-gallery-image/" + imageName,
            data: "data",
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
$("#edit-gallery-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/gallery/update",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
function addEventPost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/event/add-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
function getAllEventPost() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/event/get-all-posts",
        dataType: "html",
        success: function (response) {
...
function editEventPost(id) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/event/edit-post/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[Object.keys(response).length - 1], function (indexInArray, valueOfElement) {
...
$("#remove-event-image").click(function (e) {
    ...
    if (confirm('You can not undo this action click ok to continue')) {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/marketing/event/remove-post-image/" + imageName,
            data: "data",
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function updateEventPost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/event/update-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
$("#delete-event-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/event/remove-post",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            getAllEventPost();
...
function addCSRPost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/csr/add-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
function getAllCSRPost() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/csr/get-all-posts",
        dataType: "html",
        success: function (response) {
...
function editCSRPost(id) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/csr/edit-post/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[Object.keys(response).length - 1], function (indexInArray, valueOfElement) {
...
$("#remove-csr-image").click(function (e) {
    ...
    if (confirm('You can not undo this action click ok to continue')) {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/marketing/csr/remove-post-image/" + imageName,
            data: "data",
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function updateCSRPost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/csr/update-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
$("#delete-csr-post-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/csr/remove-post",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            getAllCSRPost();
...
function addPRPost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/pr/add-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
function getAllPRPost() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/pr/get-all-posts",
        dataType: "html",
        success: function (response) {
...
function editPRPost(id) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/marketing/pr/edit-post/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[Object.keys(response).length - 1], function (indexInArray, valueOfElement) {
...
$("#remove-pr-image").click(function (e) {
    ...
    if (confirm('You can not undo this action click ok to continue')) {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/marketing/pr/remove-post-image/" + imageName,
            data: "data",
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function updatePRPost() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/pr/update-post",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
$("#delete-pr-post-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/marketing/pr/remove-post",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            getAllPRPost();
...
function getLeadSalessheet() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/leadsalesheet/get",
        dataType: "html",
        success: function (response) {
...
function getDailySalessheet() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/dailysalesheet/get",
        dataType: "html",
        success: function (response) {
...
function getSalessheet() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/salesheet/get",
        dataType: "html",
        success: function (response) {
...
$("#sales-sheet-form").submit(function (e) {
    ...
    if (formvdalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/sales/salesheet/new",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
$("#daily-sheet-form").submit(function (e) {
    ...
    if (formvdalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/sales/dailysheet/new",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function editLeadSale(id) {
    $.ajax({
        type: "Get",
        url: base_phpurl + "/manage/sales/leadsalesheet/edit/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[response.length - 1], function (indexInArray, valueOfElement) {
...
function editDailySale(id) {
    $.ajax({
        type: "Get",
        url: base_phpurl + "/manage/sales/dailysalesheet/edit/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[response.length - 1], function (indexInArray, valueOfElement) {
...
function editSale(id) {
    $.ajax({
        type: "Get",
        url: base_phpurl + "/manage/sales/salesheet/edit/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[response.length - 1], function (indexInArray, valueOfElement) {
...
function getFieldLeadSalessheet() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/sales/field-lead-salesheet/get",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function (response) {
...
function getFiedlDailySalessheet() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/field-daily-salesheet/get",
        dataType: "html",
        success: function (response) {
...
function getFieldSalessheet() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/field-salesheet/get",
        dataType: "html",
        success: function (response) {
...
$("#fieldsales-sheet-form").submit(function (e) {
    ...
    if (formvdalidate) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/sales/fieldsalesheet/new",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
function editFieldSale(id) {
    ...
    $.ajax({
        type: "Get",
        url: base_phpurl + "/manage/sales/fieldsalesheet/edit/" + id,
        dataType: "json",
        success: function (response) {
            if (Object.keys(response).length > 0) {
                $.each(response[response.length - 1], function (indexInArray, valueOfElement) {
...
function getMerchantCommercials(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/merchant-commercials/show/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getTransactionBreakUp(merchanId) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/transaction-breakup/" + merchanId,
        dataType: "json",
        success: function (response) {
            if (typeof response != "undefined" && Object.keys(response).length > 0) {
                $.each(response, function (index, object) {
...
function getCampaigns(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/sales/get/campaiagn/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#campaigning-sheet-form").submit(function (e) {
    ...
    $.ajax({
        type: "post",
        url: base_phpurl + "/manage/sales/campaiagn",
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
$("body").on("change", ".uploadfile", function (e) {
    ...
    $.ajax({
        url: base_phpurl + '/manage/risk-complaince/merchant/document/upload',
        type: 'POST',
        data: data,
        processData: false,
        contentType: false,
...
$("body").on("click", ".button124", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/risk-complaince/merchant/document/remove",
        data: data,
        processData: false,
        contentType: false,
        cache: false,
...
$("#add-extra-document-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/risk-complaince/merchant/extra-document/upload",
        processData: false,
        contentType: false,
        cache: false,
        data: data,
...
function getMerchantExtraDocs(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/risk-complaince/merchant/extra-documents/get/" + perpage,
        data: "data",
        dataType: "html",
        success: function (response) {
...
function getMerchantBusisDetails(element) {
    ...
    if (merchant_id != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/risk-complaince/background-verification/verify/get-merchant-business-details/" + merchant_id,
            dataType: "html",
            success: function (response) {
...
function getsubcategory(element) {
    ...
    if (optionText != "Others") {
        ...
        $.ajax({
            url: base_phpurl + "/manage/risk-complaince/background-verification/verify/get-sub-category",
            type: "POST",
...
$("#rnc-report-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/risk-complaince/merchant-document/send-report",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("body").on("submit", "#background-verification-form", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/risk-complaince/background-verification/verify/new",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("body").on("submit", "#update-background-verification-form", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/risk-complaince/background-verification/verify/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllBackgroundInfo(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/risk-complaince/background-verification/verify/get-verified-merchants/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getMerchantDocsDetails(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/risk-complaince/merchant-document/verify/get-merchant-doc-detail/" + perpage,
        dataType: "html",
        success: function (response) {
...
function UpdateRncVerify(id, element) {
    ...
    if (status != "") {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/risk-complaince/merchant-details/verify/update",
...
function UpdateDocVerify(id, element) {
    ...
    if (status != "") {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/risk-complaince/merchant-document/verify/update",
...
function allCasesDetails(perpage = 10) {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/risk-complaince/grievence-cell/get/all-cases/" + perpage,
        dataType: "html",
        success: function (response) {
...
function getCommentDetails() {
    var caseid = $("#managepay-comment-form input[name='case_id']").val();
    var commentHtml = "";
...
$("#managepay-comment-form").submit(function (e) {
    e.preventDefault();
    var formdata = $("#managepay-comment-form").serializeArray();
    $.ajax({
        url: base_phpurl + "/manage/risk-complaince/grievence-cell/comment/add",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
        ...
        error: function () { },
        complete: function () {
            $("#managepay-comment-form")[0].reset();
            getCommentDetails();
            setTimeout(() => {
...
$("#case-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/risk-complaince/grievence-cell/case/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getAllEmplooyes() {
    $.ajax({
        url: base_phpurl + "/manage/hrm/get-employees",
        type: "GET",
        dataType: "html",
        success: function (response) {
...
$("#employee-details-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/hrm/get-employees/update",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
$("#delete-employee").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/get-employees/delete",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#contact-info-form").submit(function (e) {
    ...
    if (formvalidation) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/hrm/bvf/add-contact-details",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
$("#reference-info-form").submit(function (e) {
    ...
    if (formvalidation) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/hrm/bvf/add-reference-details",
            data: formdata,
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
$("#add-employee-details-form").submit(function (e) {
    ...
    $.ajax({
        url: base_phpurl + "/manage/hrm/get-employees/add",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
...
function getUploadedNda(employeeId, employeeName) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/hrm/nda/get-nda/" + employeeId,
        dataType: "html",
        success: function (response) {
...
function getUploadedConA(employeeId, employeeName) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/hrm/conagree/get-conagree/" + employeeId,
        dataType: "html",
        success: function (response) {
...
$("#nda-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/nda/upload-file",
...
$("#ca-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/ca/upload-file",
        enctype: "multipart/form-data",
        data: data,
        processData: false,
        contentType: false,
...
$("#personal-info-form").submit(function (e) {
    ...
    if (fomvalidation) {
        $.ajax({
            type: "POST",
            url: base_phpurl + "/manage/hrm/bvf/add-personal-profile",
            data: getJsonObject(formdata),
            dataType: "json",
            success: function (response) {
                if (response.status) {
...
$("#background-details-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/bvf/add",
        data: formdata,
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllPayslips() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/hrm/payroll/payslip/get",
        dataType: "html",
        success: function (response) {
...
$("#employee_id").change(function (e) {
    ...
    if (employeeId != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/hrm/payroll/payslip/get-form/" + employeeId,
            dataType: "json",
            success: function (response) {
...
$("#payslip-form").submit(function (e) {
    ...
    if (fromvalidate) {
        ...
        if (confirm("Please cross check before proceeding,\nClick cancel to cross check or Okay to continue")) {
            $.ajax({
                type: "POST",
                url: base_phpurl + "/manage/hrm/payroll/payslip/add",
                data: formdata,
                dataType: "json",
                success: function (response) {
                    if (response.status) {
...
function getPostedJobs(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/hrm/career/job/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#add-post-job-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/career/job/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function editJob(jobid) {
    if (jobid != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/hrm/career/job/edit/" + jobid,
            dataType: "json",
            success: function (response) {
                if (typeof response != undefined && Object.keys(response).length > 0) {
                    $.each(response[response.length - 1], function (key, value) {
...
$("#edit-post-job-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/career/job/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("#update-job-status").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/career/job/change-status",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function getAllApllicants(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/hrm/career/applicant/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#applicant-status-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/hrm/career/applicant/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function loadMerchantNoOfTransaction() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/merchant/no-of-transactions",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function (response) {
...
function loadMerchantTransactionAmount() {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/merchant/transaction-amount",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function (response) {
...
$(function () {
    ...
    if (window.location.href.indexOf("login") == -1) {
        ...
        $('input[name="mer_trans_date_range"]').daterangepicker({
            ...
            $(".mer_trans_date_range_form input[name='trans_date_range']").val(start.format('DD/MM/YYYY HH:mm:ss') + '-' + end.format('DD/MM/YYYY HH:mm:ss'));
            $(".mer_trans_date_range_form input[name='trans_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
            $(".mer_trans_date_range_form input[name='trans_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
            $("#transaction-download-form input[name='trans_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
            $("#transaction-download-form input[name='trans_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
        ...
        $('#merchant-transaction-form input[name="trans_date_range"]').daterangepicker({
            ...
            $("#merchant-transaction-form input[name='trans_date_range']").val(start.format('DD/MM/YYYY HH:mm:ss') + '-' + end.format('DD/MM/YYYY HH:mm:ss'));
            $("#merchant-transaction-form input[name='trans_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
            $("#merchant-transaction-form input[name='trans_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
        ...
        var momentTimeFormat = 'DD/MM/YYYY HH:mm:ss';
        var startDate = moment().subtract(5, 'days').startOf('day');
        var endDate = moment().subtract(0, 'days').endOf('day');

        $("#transaction-form input[name='trans_from_date']").val(startDate.format('YYYY-MM-DD HH:mm:ss'));
        $("#transaction-form input[name='trans_to_date']").val(endDate.format('YYYY-MM-DD HH:mm:ss'));


        // startDate=$('#transaction-form input[name="trans_from_date"]').val()==''?moment().subtract(0, 'days').startOf('day'):$('#transaction-form input[name="trans_from_date"]');
        // endDate=$('#transaction-form input[name="trans_to_date"]').val()==''?moment().subtract(0, 'days').endOf('day'):$('#transaction-form input[name="trans_to_date"]');
        ...
        $('#transaction-form input[name="trans_date_range"]').daterangepicker({
            ...
            ranges: {
                ...
                'This Month': [moment().startOf('month').startOf('day'), moment().endOf('month').endOf('day')],
                'Last Month': [moment().subtract(1, 'month').startOf('day').startOf('month'), moment().subtract(1, 'month').endOf('month').endOf('day')],
                'Last 2 Month': [moment().subtract(2, 'month').startOf('day').startOf('month'), moment().subtract(1, 'month').endOf('month').endOf('day')],
                //'This Year': [moment().startOf('year'), moment().endOf('year').endOf('day')],
            },
        }, function (start, end, label) {
            $(".loader").show();
            ...
            console.log(start);
            $("#transaction-form input[name='trans_date_range']").val(start.format('DD/MM/YYYY HH:mm:ss') + '-' + end.format('DD/MM/YYYY HH:mm:ss'));
            $("#transaction-form input[name='trans_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
            $("#transaction-form input[name='trans_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
            $("#transaction-download-form input[name='trans_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
            $("#transaction-download-form input[name='trans_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
        ...
        $('#managepay-adjustment input[name="trans_date_range"]').daterangepicker({
            opens: 'left',
            "linkedCalendars": false,
            startDate: moment().subtract(0, 'days'),
            endDate: moment().subtract(0, 'days'),
            ...
            $("#managepay-adjustment input[name='trans_date_range']").val(start.format('DD/MM/YYYY') + '-' + end.format('DD/MM/YYYY'));
            $("#managepay-adjustment input[name='trans_from_date']").val(start.format('YYYY-MM-DD'));
            $("#managepay-adjustment input[name='trans_to_date']").val(end.format('YYYY-MM-DD'));
            getS2paymentAdjustmentByDate();

        });
    }

    else if (window.location.pathname.split("/").pop() == "paysel-jmGcXynF") {
...
function loadMerchantDetails(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merchant/get-all-merchants/" + perpage,
        dataType: "html",
        success: function (response) {
...
function loadMerchantDetailsList(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merchant/get-all-merchants/" + perpage,
        dataType: "html",
...
function loadMerchantsCases() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merchant/get-all-merchant-cases",
        dataType: "html",
        success: function (response) {
...
function loadMerchantsAdjustments() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merchant/get-all-adjustments",
        dataType: "html",
        success: function (response) {
...
function loadMerchantNoOfPaylinks() {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merchant/no-of-paylinks",
        dataType: "html",
        success: function (response) {
...
function loadMerchantNoOfInvoices() {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merchant/no-of-invoices",
        dataType: "html",
        success: function (response) {
...
function loadEmlployeeLoginActivities() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/merchant/get-login-activities",
        dataType: "html",
        success: function (response) {
...
function getWorkStatus(perpage = 10) {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/work-status/get/" + perpage,
        dataType: "html",
        success: function (response) {
...
$("#work-status-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/work-status/add",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function editWorkStatus(id) {
    if (id != "") {
        $.ajax({
            type: "GET",
            url: base_phpurl + "/manage/work-status/edit/" + id,
            dataType: "json",
            success: function (response) {
                if (typeof response != undefined && Object.keys(response).length > 0) {
                    $.each(response[response.length - 1], function (key, value) {
...
$("#work-edit-status-form").submit(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/work-status/update",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function employeeloginAttempt(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/verify-credentials",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function loadEmployeeLoginForms() {
    ...
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/load-login-forms",
        dataType: "html",
        success: function (response) {
...
function employeeVerifyEmail(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/email-verify-otp",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$("body").on("submit", "#authenticator-otp-form", function (e) {
    e.preventDefault();
    var formdata = $("#authenticator-otp-form").serializeArray();

    employeeVerifyTokenOtp(formdata);

});


function employeeVerifyTokenOtp(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/2fa-verify-otp",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            ...
            if (response.status) {
                ...
                $("#success-body").html("");
                $("#auth_otp_ajax_error").html(response.message).css({ "color": "red" });
            }
        }
    });
}
...
function employeeVerifyMobile(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/mobile-verify-otp",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function verifyFirsTimeOTP(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/ft-password-change/verify-empmobile-otp",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function loadPasswordChangeForm() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/ft-password-change/send-otp-mobile",
        dataType: "html",
        success: function (response) {
            $("#load-login-form").html(response);
            $("#employee-login-modal").modal({ show: true, backdrop: 'static', keyboard: false });
...
function changeEmployeePassword(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/ft-password-change/ftpassword-change",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function adminforgotPassword(formdata) {
    ...
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/verify-employee-email",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function loadEmployeeEmailForm() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/load-email-form",
        dataType: "html",
        success: function (response) {
            $("#success-body").html("An OTP has sent to your official email").css({ "color": "green" });
            $("#load-login-form").html(response);
...
function verifyemployeeEmail(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/employee-verify-email-otp",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function loadEmployeeMobileForms() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/load-mobile-form",
        dataType: "html",
        success: function (response) {
...
function verifyemployeeMobile(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/employee-verify-mobile-otp",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
function adminResetPassword() {
    $.ajax({
        type: "GET",
        url: base_phpurl + "/manage/admin-reset-password",
        dataType: "html",
        success: function (response) {
...
function resetAdminPassword(formdata) {
    $.ajax({
        type: "POST",
        url: base_phpurl + "/manage/reset-admin-password",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function (response) {
            if (response.status) {
...
$(document).on('change keyup input', '.trans_amount', function () {
    // console.log(event.which);
    // if ((event.which != 46 || $(this).val().indexOf('.') != -1) &&

    //     ((event.which < 48 || event.which > 57 || event.which==190) &&
