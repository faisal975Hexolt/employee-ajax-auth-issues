$("#paymentsearch").submit(function(event){
    ...
    $.ajax({
        url:base_phpurl+"/merchant/payments",
        type:"POST",
...
$("#ordersearch").submit(function(event){
    ...
    $.ajax({
     url:base_phpurl+"/merchant/orders",
     type:"POST",
     data:getJsonObject(formdata),
     dataType:"json",
     success:function(response){
...
$("#refundsearch").submit(function(event){
    ...
    $.ajax({
     url:base_phpurl+"/merchant/refunds",
     type:"POST",
     data:getJsonObject(formdata),
     dataType:"json",
     success:function(response){
...
$("#disputesearch").submit(function(event){
    ...
    $.ajax({
     url:base_phpurl+"/merchant/disputes",
     type:"POST",
     data:getJsonObject(formdata),
     dataType:"json",
     success:function(response){
...
$("#settlementsearch").submit(function(event){
    ...
    $.ajax({
     url:base_phpurl+"/merchant/settlements",
     type:"POST",
     data:getJsonObject(formdata),
     dataType:"json",
     success:function(response){
...
$("#invoicesearch").submit(function(event){
    ...
    $.ajax({
     url:base_phpurl+"/merchant/invoices",
     type:"POST",
     data:getJsonObject(formdata),
     dataType:"json",
     success:function(response){
...
$("#itemsearch").submit(function(event){
    ...
    $.ajax({
     url:base_phpurl+"/merchant/items",
     type:"POST",
     data:getJsonObject(formdata),
     dataType:"json",
     success:function(response){
...
$("#paylinksearch").submit(function(event){
    ...
    $.ajax({
     url:base_phpurl+"/merchant/paylinks",
     type:"POST",
     data:getJsonObject(formdata),
     dataType:"json",
     success:function(response){
