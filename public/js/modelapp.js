...
$(function () {
    $('input[name="transaction_download_range_summary"]').daterangepicker({
        opens: 'right',
        ...
        $("#transaction-download-form input[name='transaction_download_range_summary']").val(start.format('DD/MM/YYYY HH:mm:ss') + '-' + end.format('DD/MM/YYYY HH:mm:ss'));
...
$(function () {
    ...
    start1 = moment().subtract(4, 'days').startOf('day');
    end1 = moment().subtract(0, 'days').endOf('day');

    $(".report_start_date").val(start1.format('YYYY-MM-DD HH:mm:ss'));
    $(".report_end_date").val(end1.format('YYYY-MM-DD HH:mm:ss'));


    $('.transaction_download_report').daterangepicker({
        dateLimit: {
            days: 61
        },
        minDate: moment().subtract(365, 'days'),
        ...
        $(".transaction_download_report").val(start.format('DD/MM/YYYY HH:mm:ss') + '-' + end.format('DD/MM/YYYY HH:mm:ss'));
        $(".report_start_date").val(start.format('YYYY-MM-DD HH:mm:ss'));
        $(".report_end_date").val(end.format('YYYY-MM-DD HH:mm:ss'));
        $(".loader_custom").hide();
    });
...
$(function () {
    $('input[name="order_download_range"]').daterangepicker({
        opens: 'right',
        "linkedCalendars": true,
        dateLimit: {
            days: 61
        ...
        $("#order-download-form input[name='order_download_range']").val(start.format('DD/MM/YYYY HH:mm:ss') + '-' + end.format('DD/MM/YYYY HH:mm:ss'));
        $("#order-download-form input[name='order_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
        $("#order-download-form input[name='order_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
        // getMyTransactionsByDate();
...
function setTransactionsPage(perpage = 10) {
    $(".loader_custom").show();
    $("#transaction-download-form input[name='perpage']").val(perpage);
    getMyTransactionsByDate();
}

function setResellerTransactionsPage(perpage = 10) {
    $(".loader_custom").show();
    $("#transaction-download-form input[name='perpage']").val(perpage);
    getResellerTransactionsByDate();
}

function getMyTransactionsByDate() {
    $(".loader_custom").show();
    var formdata = $("#transaction-download-form").serializeArray();
    $.ajax({
        type: "POST",
        url: base_phpurl + "/merchant/fetchpayment",
...
function getResellerTransactionsByDate() {
    $(".loader_custom").show();
    var formdata = $("#transaction-download-form").serializeArray();

    $.ajax({
        type: "POST",
        url: base_phpurl + "/reseller/fetchpayment",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function (response) {
            $("#paginate_payment").html(response);
...
$(function () {
    $('input[name="dash_date_range_summary"]').daterangepicker({
        ...
        startDate: moment().startOf('day'), // Start of the day
        endDate: moment().startOf('day').add(1, 'hour'), // Same day with 1 hour difference
        maxDate: new Date(),
        autoclose: true,
        timePicker: true,
        timePicker24Hour: false,
        ...
        $("#dashboard-form-summary input[name='dash_date_range_summary']").val(start.format('DD/MM/YYYY HH:mm:ss') + ' - ' + end.format('DD/MM/YYYY HH:mm:ss'));
        $("#dashboard-form-summary input[name='dash_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
        $("#dashboard-form-summary input[name='dash_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
...
$(function () {
    ...
    var end = moment();
    $("#dashboard-form-payout input[name='dash_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
    $("#dashboard-form-payout input[name='dash_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));

    $('input[name="dash_date_range_payout"]').daterangepicker({
        dateLimit: {
            days: 61
        },
        minDate: moment().subtract(365, 'days'),
        ...
        $(".loader_custom").show();
        $("#dashboard-form-payout input[name='dash_date_range_payout']").val(start.format('DD/MM/YYYY') + '-' + end.format('DD/MM/YYYY'));
        $("#dashboard-form-payout input[name='dash_from_date']").val(start.format('YYYY-MM-DD HH:mm:ss'));
        $("#dashboard-form-payout input[name='dash_to_date']").val(end.format('YYYY-MM-DD HH:mm:ss'));
...
$(".transaction-fa-calendar-summary").click(function (e) {
    e.preventDefault();
    $("input[name='transaction_download_range_summary']").focus();
})


$(".transaction_download_report-cal").click(function (e) {
    e.preventDefault();
    $("input[name='transaction_download_report']").focus();
})


$(".order-fa-calendar-summary").click(function (e) {
    e.preventDefault();
    $("input[name='order_download_range']").focus();
})
...
$("#invoice-add-form #add-invoice-items").click(function (event) {
    ...
    new_invoice_item_row = `<tr id='invoice_item_row` + trlength + `'>
            <td>
                <div class="col-sm-10">
                    <select name="item_name[]" id="item_name`+ trlength + `" class="form-control item_name_list" onchange=itemCalculate(this); data-name-id="` + trlength + `">
...
$("[data-target='#reseller-payments']").click(function (e) {
    e.preventDefault();
    getAllResellerPayments();

});

$("[data-target='#reseller-refunds']").click(function (e) {
    e.preventDefault();
    getAllResellerRefunds();
});

$("[data-target='#reseller-orders']").click(function (e) {
    e.preventDefault();
    getAllResellerOrders();
});

$("[data-target='#reseller-disputes']").click(function (e) {
    e.preventDefault();
    getAllResellerDisputes();
});