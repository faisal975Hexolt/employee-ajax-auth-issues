...
function transactionDetails(trans_id)
{
    ...
    $.ajax({
        url:base_phpurl+"/merchant/employee/payment/get/"+trans_id,
        type:"GET",
        dataType:"json",
...
function getAllTransactionDetails(perpage=10){
    $.ajax({
        type:"GET",
        url:base_phpurl+"/merchant/employee/get-transactions/"+perpage,
        dataType: "html",
        success: function (response) {
...
function getAllPaylinks(perpage=10){
    $.ajax({
        type:"GET",
        url:base_phpurl+"/merchant/employee/get-paylinks/"+perpage,
        dataType: "html",
        success: function (response) {
...
$("#paylinkadd").submit(function(e){
    ...
    if(paylinkid == "" && formvalidate)
    {
        ...
        $.ajax({
            url:base_phpurl+"/merchant/employee/paylink/add",
            type:"POST",
...
//Edit paylink javascript functionality starts
    function editPaylink(paylinkid){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/employee/paylink/edit/"+paylinkid,
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.length>0)
    ...
    $("#paylink-edit").submit(function(event){
        ...
        if(paylinkid != "" && formvalidate)
        {
            ...
            $("div#divLoading").addClass('show');
            $.ajax({
                url:base_phpurl+"/merchant/employee/paylink/update",
                type:"POST",
                data:getJsonObject(formdata),
                dataType:"json",
                success:function(response){
    ...
    function getAllQuickLinks(perpage=10) {
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/employee/get-quick-paylinks/"+perpage,
            dataType: "html",
            success: function (response) {
    ...
    $("#quick-link-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/employee/quicklink/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    function getAllLogActivities(perpage=10){
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/employee/merchant-emp-login-log/"+perpage,
            dataType:"html",
            success: function (response) {
